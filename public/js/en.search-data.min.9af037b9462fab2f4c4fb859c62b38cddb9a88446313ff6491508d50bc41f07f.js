...
Agent Management User Management Monitor &amp; Discovery Reports Licensing SNMP Installation and Configuration Security `}),e.add({id:8,href:"/modules/test/",title:"Test",content:`This is a test main category page.
Test Page `}),e.add({id:9,href:"/installation/cloud_vista/",title:"Cloud Vista",content:`Cloud Vista Suite (CVS) by NetGain Systems is a scalable monitoring service for hybrid cloud environments, providing monitoring of networks, servers, databases, applications, and services, through a SaaS-based monitoring analytics platform
...
`}),e.add({id:206,href:"/tags/",title:"Tags",content:""}),e.add({id:207,href:"/modules/test/testpage/",title:"Test Page",content:`This is a test page.
