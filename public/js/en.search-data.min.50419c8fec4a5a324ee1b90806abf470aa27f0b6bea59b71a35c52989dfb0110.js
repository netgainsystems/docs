...
`}),e.add({id:97,href:"/administrative/admin/logs/debuglog/",title:"Debug Logs",content:`Click on &lt;Debug logs&gt; in the Top navigation bar.
Turn on the debug log for debugging purpose only, choose the level of the logs to enable debugging.
`}),e.add({id:98,href:"/modules/home/dashboards/deletedashboard/",title:"Deleting Dashboard",content:`Click on the button at the corner to delete dashboard.
`}),e.add({id:99,href:"/modules/cmdb/deviceconfiguration/",title:"Device Configuration Management",content:`Click on &lt;Devices&gt; at the top menu of &lt;Network Config&gt;, then click on the name of the device whose configuration you want to manage.
...
`}),e.add({id:102,href:"/modules/metrics/discovering/",title:"Discovering / Adding Devices to be Monitored",content:` Discover Device To discover or add devices to be monitored, click on &lt;Metrics&gt; in the Left Navigation Bar, then &lt;Discover&gt; in the Top Navigation Bar.
...
Discover Device: Discovers devices and monitors each device using IP address range and specific IP addresses `}),e.add({id:103,href:"/modules/metrics/editsettings/",title:"Editing Monitoring Settings",content:`Click on &lt;Metrics&gt; in the Left Navigation Bar, then &lt;Metrics&gt; in the Top Navigation Bar. Then click on &lt;Objects&gt; in the top menu, and click on &lt;Device view&gt;.
