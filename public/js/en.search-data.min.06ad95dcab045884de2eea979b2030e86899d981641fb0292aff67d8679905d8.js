...
Authentication is auto-enabled in new ElasticSearch v8.x.x and take note of the generated random password (underlined in red) during installation: Authentication and authorization are enabled. TLS for the transport and HTTP layers is enabled and configured. The generated password for the elastic built-in superuser is : t_uYH54WkAddVJ8qAK9s
...
`}),e.add({id:170,href:"/modules/alerts/othersettings/",title:"Other Alert Notification Settings",content:`Besides Email and SMS notification, there are other methods to alert users, including 3rd party messaging apps such as Slack, MS Teams, WeChat, Alicloud, LINE and Telegram.
...
`}),e.add({id:171,href:"/modules/siem/log_analytics/reports/compliance/pcidss/",title:"PCI-DSS",content:`In &lt;PCI-DSS&gt; there are 6 report templates.
...
Windows : File Created Windows : File Deleted Windows : File Modified Windows : File Permission Changes `}),e.add({id:172,href:"/modules/siem/reports/compliance/pcidss/",title:"PCI-DSS",content:`In &lt;PCI-DSS&gt; there are 6 report templates.
PCI-DSS requirements 10.1
Windows : Failed Network Logons Windows : Failed User Logons Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Network Logoffs Windows : Network Logon Windows : Registry Created Windows : Registry Deleted Windows : Registry Value Modified Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : User Logoff Windows : User Logon Windows : Windows Individual User Action PCI-DSS requirements 10.2.1
Windows : Failed Network Logons Windows : Failed User Logons Windows : Network Logoffs Windows : Network Logon Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : User Logoff Windows : User Logon PCI-DSS requirements 10.2.2
Windows : Failed Network Logons Windows : Failed User Logons Windows : Network Logoffs Windows : Network Logon Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : User Logoff Windows : User Logon Windows : Windows Individual User Action PCI-DSS requirement 10.2.3
Windows : Audit Policy Changed Windows : Failed Network Logons Windows : Failed User Logons Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Network Logoffs Windows : Network Logon Windows : Registry Created Windows : Registry Deleted Windows : Registry Value Modified Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : Trusted Domain Created Windows : Trusted Domain Deleted Windows : Trusted Domain Modified Windows : User Logoff Windows : User Logon Windows : User Right Assigned Windows : User Rights Removed Windows : Windows Firewall Group Policy Changes Windows : Windows Firewall Rule Added Windows : Windows Firewall Rule Deleted Windows : Windows Firewall Rule Modified Windows : Windows Firewall Setting Changed Windows : Windows Firewall Setting Restored PCI-DSS requirements 10.2.6
Windows : AD Backup Error Windows : Audit Logs Cleared Windows : Error in EventLog Service Windows : Event log automatic backup Windows : Falied hotpatcing Windows : Failed software installations Windows : Failed software installations due to privilege mismatches Windows : New Service Installed Windows : Software Installed Windows : Software Uninstalled Windows : Software Updated Windows : Windows Startup and Windows Shutdown PCI-DSS requirements 10.2.7
Windows : File Created Windows : File Deleted Windows : File Modified Windows : File Permission Changes `}),e.add({id:173,href:"/modules/siem/log_analytics/reports/compliance/pdpa/",title:"PDPA",content:`In &lt;PDPA&gt; there are 2 report templates.
RULE VI Section 25
Windows : Failed Network Logons Windows : Failed User Logons Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Network Logoffs Windows : Network Logon Windows : Removable Disk Creates Windows : Removable Disk Deletes Windows : Removable Disk Failed Creates Windows : Removable Disk Failed Deletes Windows : Removable Disk Failed Modifications Windows : Removable Disk Failed Reads Windows : Removable Disk Modifications Windows : Removable Disk Reads Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : Unsuccessful Post Authentication Windows : Unsuccessful Pre Authentication Windows : User Logoff Windows : User Logon Windows : Windows Individual User Action Windows : Wireless Network Authentications Windows : Wireless Network Connected Windows : Wireless Network Disconnected RULE VII Section 30
Windows : Failed Network Logons Windows : Failed User Logons Windows : File Created Windows : File Deleted Windows : File Modified Windows : File Permission ChangesWindows : Network Logoffs Windows : Network Logon Windows : Removable Disk Creates Windows : Removable Disk Deletes Windows : Removable Disk Failed Creates Windows : Removable Disk Failed Deletes Windows : Removable Disk Failed Modifications Windows : Removable Disk Failed Reads Windows : Removable Disk Modifications Windows : Removable Disk Reads Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : UnSuccessful Post Authentication Windows : UnSuccessful Pre Authentication Windows : User Logoff Windows : User Logon Windows : Windows Individual User Action Windows : Wireless Network Authentications Windows : Wireless Network Connected Windows : Wireless Network Disconnected `}),e.add({id:174,href:"/modules/siem/reports/compliance/pdpa/",title:"PDPA",content:`In &lt;PDPA&gt; there are 2 report templates.
RULE VI Section 25
Windows : Failed Network Logons Windows : Failed User Logons Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Network Logoffs Windows : Network Logon Windows : Removable Disk Creates Windows : Removable Disk Deletes Windows : Removable Disk Failed Creates Windows : Removable Disk Failed Deletes Windows : Removable Disk Failed Modifications Windows : Removable Disk Failed Reads Windows : Removable Disk Modifications Windows : Removable Disk Reads Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : Unsuccessful Post Authentication Windows : Unsuccessful Pre Authentication Windows : User Logoff Windows : User Logon Windows : Windows Individual User Action Windows : Wireless Network Authentications Windows : Wireless Network Connected Windows : Wireless Network Disconnected RULE VII Section 30
Windows : Failed Network Logons Windows : Failed User Logons Windows : File Created Windows : File Deleted Windows : File Modified Windows : File Permission ChangesWindows : Network Logoffs Windows : Network Logon Windows : Removable Disk Creates Windows : Removable Disk Deletes Windows : Removable Disk Failed Creates Windows : Removable Disk Failed Deletes Windows : Removable Disk Failed Modifications Windows : Removable Disk Failed Reads Windows : Removable Disk Modifications Windows : Removable Disk Reads Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : UnSuccessful Post Authentication Windows : UnSuccessful Pre Authentication Windows : User Logoff Windows : User Logon Windows : Windows Individual User Action Windows : Wireless Network Authentications Windows : Wireless Network Connected Windows : Wireless Network Disconnected `}),e.add({id:175,href:"/administrative/tools/diagnostic/ping/",title:"Ping",content:`This tool helps user to verify the connectivity between NetGain Systems Infrastructure Monitoring server and the destination devices.
...
`}),e.add({id:176,href:"/troubleshooting_guides/FAQ/reporting/",title:"Report",content:`In Construction
`}),e.add({id:177,href:"/modules/apm/reports/",title:"Reports",content:`The report module is used to generate ad-hoc reports. This module supports:
...
Once done, click on ‘Save’.
`}),e.add({id:178,href:"/modules/netflow/reports/",title:"Reports",content:`You can create different NetFlow reports based on different search expressions.
...
`}),e.add({id:179,href:"/modules/siem/log_analytics/reports/",title:"Reports",content:`To access the SIEM Reports function, click on the &lt;SIEM&gt; icon at the Left Navigation Bar then click on &lt;Reports&gt; at the Top Navigation Bar.
There are 4 sub-menus in the Reports function:
Common Applications Compliance Ad Hoc `}),e.add({id:180,href:"/modules/siem/reports/",title:"Reports",content:`To access the SIEM Reports function, click on the &lt;SIEM&gt; icon at the Left Navigation Bar then click on &lt;Reports&gt; at the Top Navigation Bar.
There are 4 sub-menus in the Reports function:
Common Applications Compliance Ad Hoc `}),e.add({id:181,href:"/administrative/admin/system/restapis/",title:"Rest APIs",content:`This module describes the REST API and resources provided by NetGain Systems Infrastructure Monitoring.
Click on &lt;Rest APIs&gt; in the navigation bar.
`}),e.add({id:182,href:"/administrative/admin/accounts/roles/",title:"Roles",content:`The Administrator can control the newly created user’s access right through Roles. To create new role for the End-User. Click on &lt;+Create&gt; in the page.
...
`}),e.add({id:183,href:"/modules/metrics/metrics/rulesaudit/",title:"Rules Audit",content:`User will be able to determine the standardization of the threshold parameters. It lets the user merge the old settings to new settings to make it standard.
...
`}),e.add({id:184,href:"/modules/home/dashboards/savedashboard/",title:"Saving Dashboard",content:`Click on the button at the corner to save the dashboard.
`}),e.add({id:185,href:"/administrative/admin/logs/schedulerlog/",title:"Scheduler Logs",content:`Click on &lt;Scheduler logs&gt; in the Top navigation bar.
It shows the scheduler running history logs:
`}),e.add({id:186,href:"/modules/cmdb/schedulingbackup/",title:"Scheduling Configuration Backup",content:`This lets you schedule the backup of your Network Configuration. Click on &lt;Schedules&gt; at the top menu of &lt;Network Config&gt;.
...
`}),e.add({id:187,href:"/modules/siem/log_analytics/schema/",title:"Schema",content:`This is information tab about Elastic Common Schema. User can get more from the following link: https://www.elastic.co/guide/en/ecs/current/index.html
`}),e.add({id:188,href:"/modules/siem/log_analytics/search/",title:"Search",content:`SIEM search is for the user to do simple search through keywords or to do advance query string search. Example simple search:
...
`}),e.add({id:189,href:"/modules/siem/search/",title:"Search",content:`The search function here is like the search bar on Log Analytics. User can do simple search or advance query string on the logs that recorded threat. &lt;Help&gt; can be used to learn more about the query syntax.
User can select the time range and look at the number of threat logs on different time range.
`}),e.add({id:190,href:"/modules/siem/security_analytics/search/",title:"Search",content:`The search function here is like the search bar on Log Analytics. User can do simple search or advance query string on the logs that recorded threat. &lt;Help&gt; can be used to learn more about the query syntax.
User can select the time range and look at the number of threat logs on different time range.
`}),e.add({id:191,href:"/troubleshooting_guides/FAQ/security/",title:"Security",content:`How to request CSR generation Please change the following details according to customer requirements.
...
Event.outcome Host.ip Transaction.duration.us Source.ip User OS Transaction type User browser `}),e.add({id:193,href:"/installation/cloud_vista/setting-up/",title:"Setting up",content:"Getting up and running Signup for at CVS account at https://portal.netgain-systems.com/signup Login to your portal at https://portal.netgain-systems.com/login to create your CVS instance Install and setup emedge at local site(s) by following steps in this page Optionally install emedge-agent software on your server hosts that you would like to manage, with these steps Once done, monitoring metrics, logs and traffic data will now be automatically streamed to the assigned CVS instance "}),e.add({id:194,href:"/modules/netflow/settings_maintenance/",title:"Settings and Maintenance",content:`To navigate to NetFlow settings, click &lt;NetFlow&gt; on the Left navigation bar then &lt;Settings&gt;.
Applications Maintenance `}),e.add({id:195,href:"/administrative/admin/elasticsearch/shards/",title:"Shards",content:`Click on &lt;Shards&gt; in the Top navigation bar.
...
`}),e.add({id:196,href:"/troubleshooting_guides/FAQ/snmpinstall/",title:"SNMP Installation & Configuration",content:`How to discover monitors through SNMPV3 Click on Metrics, Discover.
...
`}),e.add({id:197,href:"/modules/metrics/metrics/snmpv3users/",title:"SNMP V3 Users",content:`The SNMP v3 user credentials can be set here.
Click &lt;Metrics&gt; on the Left navigation bar then &lt;Policy&gt;. Under &lt;SNMP v3 Users&gt; click &lt;Add new user&gt;.
`}),e.add({id:198,href:"/administrative/tools/diagnostic/snmpwalk/",title:"SNMPWALK",content:`This tool helps user to test the SNMP connectivity between NetGain Systems EM server to the destination devices and get the SNMP.
...
`}),e.add({id:199,href:"/modules/siem/log_analytics/sources/",title:"Sources",content:`This section enables the user to add logs into the system.
...
`}),e.add({id:200,href:"/modules/siem/log_analytics/reports/compliance/sox/",title:"SOX",content:`In &lt;SOX&gt; there are 7 report templates.
SEC 302(a)(4)(A)
...
`}),e.add({id:204,href:"/administrative/admin/system/",title:"System",content:`System page allows End-User to see the overview of logs on the NetGain Systems Infrastructure Monitoring systems, system diagnostics to check on the system for error and system uptime.
Status License Rest APIs `}),e.add({id:205,href:"/administrative/admin/logs/systemlog/",title:"System Logs",content:`The End-User can quickly download Infrastructure Monitoring system related logs such as System Log, Operation Log, Vista logs, Notifications log, Scheduler log, Internal log, and Debug log as text files or Excel file for analysis.
...
`}),e.add({id:206,href:"/tags/",title:"Tags",content:""}),e.add({id:207,href:"/modules/siem/security_analytics/threatdetection/",title:"Threat Detection",content:`By default, NetGain Systems support around 500 detection rules. Detection rules are done through the query string.
...
`}),e.add({id:208,href:"/modules/siem/threatdetection/",title:"Threat Detection",content:`By default, NetGain Systems support around 500 detection rules. Detection rules are done through the query string.
For default rule, user can &lt;Disable&gt;, &lt;Enable&gt; and &lt;Edit&gt; the tags or description (but not query expression) in the edit.
To add new rule, user can add in &lt;Add new rule&gt;. User just need to specific the name, tags, description accordingly.
User can define the &lt;interval&gt; on how frequent for SIEM to run through this rule. For &lt;search window&gt; under logic type query, user can define the historical search window.
NetGain Systems supports 3 types of logic type: Python(sandbox), Query and Workflow to create new rules.
Python: Python API documentation is available in the GUI Query: Using search query or query expression. Workflow: Flow chart type logic. The workflows can be created in the &lt;AI Workflows&gt; Threat Intelligence &amp; Lookup Tables Threat Intelligence is where NetGain Systems gather the flagged IP or URL from establish sources and compare against the logs. User can choose to enable or disable particular sources.
For lookup tables, user can use it to create table to map key to a value. The key can be used in python script to run certain rules.
`}),e.add({id:209,href:"/modules/siem/security_analytics/threatevents/",title:"Threat Events",content:`In Threat Events, user can search for the threat events based on their threat ID or threat message. Clicks on the events will bring up all the related log that linked to this threat.
User can also select the different time range to check for the events that happened.
`}),e.add({id:210,href:"/modules/siem/threatevents/",title:"Threat Events",content:`In Threat Events, user can search for the threat events based on their threat ID or threat message. Clicks on the events will bring up all the related log that linked to this threat.
User can also select the different time range to check for the events that happened.
`}),e.add({id:211,href:"/modules/metrics/thresholdsettings/",title:"Threshold Settings",content:`Click on &lt;Metrics&gt; in the Left Navigation Bar, then &lt;Metrics&gt; in the Top Navigation Bar. Then click on &lt;Objects&gt; in the top menu, and click on &lt;Device view&gt;. To adjust the threshold settings, click on the device type / device on the right side of the table and drill down till you see the monitoring parameter you would like to change. Click &lt;Edit&gt; to enable the edit mode and click the – Change threshold settings icon to edit the threshold settings.
...
`}),e.add({id:212,href:"/modules/siem/log_analytics/reports/adhoc/addreport/",title:"To add a new report",content:`Click &lt;+Add new report&gt;.
...
Save – Save report
`}),e.add({id:213,href:"/modules/siem/reports/adhoc/addreport/",title:"To add a new report",content:`Click &lt;+Add new report&gt;.
Report title – Enter report title.
Category – Enter report category.
Description – Enter description of report.
Search expression – Enter search expression.
Visibility – Select who can see this report (Owner/All)
Save – Save report
`}),e.add({id:214,href:"/modules/siem/log_analytics/reports/adhoc/autodelivery/",title:"To create auto delivery report setting",content:`
...
Save – Save report
`}),e.add({id:215,href:"/modules/siem/reports/adhoc/autodelivery/",title:"To create auto delivery report setting",content:`
Mail Subject – enter mail subject.
Mail Body – Enter mail body.
Target Address (s) – Enter email address.
Format – Select report file type. (Excel/PDF)
...
Hour of day – Enter number of hour
Save – Save report
`}),e.add({id:216,href:"/modules/siem/log_analytics/reports/adhoc/downloadreport/",title:"To download report",content:`Download Excel – Download report to local computer in Excel file.
Download PDF – Download report to local computer in PDF file.
Download CSV – Download report to local compute in SCV file
`}),e.add({id:217,href:"/modules/siem/reports/adhoc/downloadreport/",title:"To download report",content:`Download Excel – Download report to local computer in Excel file.
Download PDF – Download report to local computer in PDF file.
Download CSV – Download report to local compute in SCV file
`}),e.add({id:218,href:"/modules/siem/log_analytics/reports/adhoc/editreport/",title:"To edit report",content:`
Report title – Enter report title.
Category – Enter report category.
Description – Enter description of report.
Search expression – Enter search expression.
...
Save – Save report
`}),e.add({id:219,href:"/modules/siem/reports/adhoc/editreport/",title:"To edit report",content:`
Report title – Enter report title.
Category – Enter report category.
Description – Enter description of report.
Search expression – Enter search expression.
...
Delete report – Delete report
Save – Save report
`}),e.add({id:220,href:"/administrative/tools/",title:"Tools",content:`NetGain Systems Infrastructure Monitoring provides diagnostic tools for troubleshooting and agents for installation on the servers that needs to be monitored. Click on &lt;Tools&gt; at the left navigation bar.
Diagnostic Agent Download `}),e.add({id:221,href:"/modules/home/topnavbar/",title:"Top Navigation Bar",content:`The Top Navigation Bar displays different functions, depending on the module selected from the Left Navigation Bar. The current selected function will be underlined. For the Home Page, the available functions are:
Dashboards: for default dashboards as well customizable dashboards to display. BizViews: to view the services availability, status and performance from a business or services perspectives. Maps: to view devices status from a logical, physical or geographic view. `}),e.add({id:222,href:"/troubleshooting_guides/FAQ/user_management/",title:"User Management",content:`How to unlock my user account if its locked Admin account is needed in order to unlock user’s account.
...
Change the input to the desired days. `}),e.add({id:223,href:"/administrative/admin/accounts/users/",title:"Users",content:`You can specify different access rights for different roles, for example, specifying that business staff only receive system warnings but not able to perform operations. Different access rights will affect the administrative rights you have, and thus access to features in the Administrator interface.
...
`}),e.add({id:224,href:"/modules/netflow/usingnta/",title:"Using Network Traffic Analytics",content:`The &lsquo;Overview&rsquo; tab displays the general summary of network traffic data.
...
`}),e.add({id:225,href:"/modules/apm/watcher/",title:"Watcher",content:`APM Watcher is used to watch out for specified data within APM. The system generates an alarm when the data contains the specified query string. This is useful for identifying problems quickly.
...
`}),e.add({id:228,href:"/modules/siem/watcher/",title:"Watcher",content:`This function is used to watch out for specified data within incoming data logs. The system sends an alarm when the incoming log data contains a specified key word or phrase. This is useful to detect any known abnormalities or behavior.
To access the Watcher function, click on the &lt;SIEM&gt; icon at the Left Navigation Bar then click on &lt;Watcher&gt; at the Top Navigation Bar if not already at the Reports page.
Add Watcher Rule Click on Watcher &lt; &gt; and when you are in the Watcher menu, click .
Enter the data and rules to define what you want to watch out for and receive an alarm when the conditions are met.
Name – Input name of rule.
...
To view LogWatch alerts When the Watcher rule has been created and enabled, an alert will be generated if the specified key word or phrase is detected.
To see the alert message, click on Alerts icon at the Left Bavigation bar then click on &lt;Alerts&gt; at the Top Navigation Bar than click on &lt;Current&gt; at the sub menu bar then select &lt;LogsWatch Alarms&gt; at the drop down list menu.
`}),e.add({id:229,href:"/modules/home/dashboards/widgetdetails/",title:"Widget Details",content:` Category Widget Name Description Logs Histogram Query string driven. Shows logs histogram by different aggregation methods in the form of bar, line and area graphs.
