...
Maintenance Indices Shards Cluster Nodes `}),e.add({id:106,href:"/administrative/emedge_sites/",title:"Emedge Sites",content:`Sites are used for monitoring and managing distinct environments or deployments within the organization.
...
Information includes:
Infra Monitoring (Nodes): Bar chart showing the number of nodes being monitored over time Logs: Bar chart showing the daily volume of logs in megabytes NetFlow: Bar chart showing the daily volume of NetFlow data in megabytes Network Configuration Management: Bar chart showing the number of nodes involved in network configuration management Application Performance Monitoring: Bar chart showing the daily transaction spans `}),e.add({id:107,href:"/modules/siem/log_analytics/reports/compliance/ferpa/",title:"FERPA",content:`In &lt;FERPA&gt; there is 1 report template.
Section 99.31 (a)(1)(ii)
Windows : File Created Windows : Files Deleted Windows : Files Modified Windows : File Permission Changes Windows : Removable Disk Creates Windows : Removable Disk Deletes Windows : Removable Disk Failed Creates Windows : Removable Disk Failed Deletes Windows : Removable Disk Failed Modifications Windows : Removable Disk Failed Reads Windows : Removable Disk Modifications Windows : Removable Disk Reads `}),e.add({id:108,href:"/modules/siem/reports/compliance/ferpa/",title:"FERPA",content:`In &lt;FERPA&gt; there is 1 report template.
Section 99.31 (a)(1)(ii)
Windows : File Created Windows : Files Deleted Windows : Files Modified Windows : File Permission Changes Windows : Removable Disk Creates Windows : Removable Disk Deletes Windows : Removable Disk Failed Creates Windows : Removable Disk Failed Deletes Windows : Removable Disk Failed Modifications Windows : Removable Disk Failed Reads Windows : Removable Disk Modifications Windows : Removable Disk Reads `}),e.add({id:109,href:"/modules/siem/log_analytics/filters/",title:"Filters",content:`User can use filters function to exclude processing certain logs.
Example: To exclude logs that contain “session event 1656” .
After setting filter, user can test the rule using &lt;Test filters&gt;.
`}),e.add({id:110,href:"/modules/siem/log_analytics/reports/compliance/fisma/",title:"FISMA",content:`In &lt;FISMA&gt; there are 10 report templates.
Access Control (AC)
...
Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected `}),e.add({id:111,href:"/modules/siem/reports/compliance/fisma/",title:"FISMA",content:`In &lt;FISMA&gt; there are 10 report templates.
Access Control (AC)
Windows : Failed Network Logons Windows : Failed User Logons Windows : Network Logons Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : User Logoff Windows : User Logon Access Control (AC)
Successful/Unsuccessful User Logons/Logoffs Audit and Accountability (AU)
Windows : File Created Windows : File Deleted Windows : File Modified Windows : File Permission Changes Audit and Accountability (AU) – Object Access
...
Windows : Failed Windows backup Windows : Failed Windows restores Windows : Successful Windows restores Windows Successful Windows backup Identification and Authentication (IA)
Windows : Windows individual User Action Information System Monitoring(SI-4)
Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected `}),e.add({id:112,href:"/modules/siem/log_analytics/reports/compliance/gdpr/",title:"GDPR",content:`In &lt;GDPR&gt; there are 4 report templates.
GDPR ARTICLE 32 (1B)
...
Windows : Audit Policy Changed Windows : Failed Network Logons Windows : Failed User Logons Windows : File Created Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Network Logoffs Windows : Network Logon Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : Trusted Domain Created Windows : Trusted Domain Deleted Windows : Trusted Domain Modified Windows : Unsuccessful Post Authentication Windows : Unsuccessful Pre Authentication Windows : User Logoff Windows : User Logon Windows : User Rights Assigned Windows : User Right Removed Windows : Windows individual User Action `}),e.add({id:113,href:"/modules/siem/reports/compliance/gdpr/",title:"GDPR",content:`In &lt;GDPR&gt; there are 4 report templates.
GDPR ARTICLE 32 (1B)
Windows : Computer Account Created Windows : Computer Account Deleted Windows : Computer Account Modified Windows : Group Created Windows : Group Deleted Windows : Group Modified Windows : User Account Created Windows : User Account Deleted Windows : User Account Locked Outs Windows : User Account Modified GDPR ARTICLE 32 (1D)
Windows : File Created Windows : File Deleted Windows : File modified Windows : File Permission Changes GDPR ARTICLE 5 (1B)
Windows : Audit Policy Changed Windows : Failed Network Logons Windows : Failed User Logons Windows : File Created Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Network Logoffs Windows : Network Logon Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : Trusted Domain Created Windows : Trusted Domain Deleted Windows : Trusted Domain Modified Windows : Unsuccessful Post Authentication Windows : Unsuccessful Pre Authenticaation Windows : User Logoff Windows : User Logon Windows : User Rights Assigned Windows : User Right Removed Windows : Windows individual User Action GDPR ARTICLE 5 (1F)
Windows : Audit Policy Changed Windows : Failed Network Logons Windows : Failed User Logons Windows : File Created Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Network Logoffs Windows : Network Logon Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : Trusted Domain Created Windows : Trusted Domain Deleted Windows : Trusted Domain Modified Windows : Unsuccessful Post Authentication Windows : Unsuccessful Pre Authentication Windows : User Logoff Windows : User Logon Windows : User Rights Assigned Windows : User Right Removed Windows : Windows individual User Action `}),e.add({id:114,href:"/modules/home/maps/geomap/",title:"Geographical Map",content:`Google Map provides a geographical view of the devices in the IT infrastructure.
...
`}),e.add({id:115,href:"/modules/siem/log_analytics/reports/compliance/glba/",title:"GLBA",content:`In &lt;GLBA&gt; there are 2 report templates.
Section 501B (1)
...
`}),e.add({id:118,href:"/modules/siem/log_analytics/reports/compliance/gpg/",title:"GPG",content:`In &lt;GPG&gt; there are 5 report templates.
...
Windows : Audit Policy Changed Windows : Trusted Domain Created Windows : Trusted Domain Deleted Windows : Trusted Domain Modified Windows : User Right Assigned Windows : User Rights Removed `}),e.add({id:119,href:"/modules/siem/reports/compliance/gpg/",title:"GPG",content:`In &lt;GPG&gt; there are 5 report templates.
Recording Relating to Network Connections (PMC Rule 6)
Windows : Failed Network Logons Windows : Failed User Logons Windows : Network Logon Windows : User Logoff Windows : User Logon Recording on Data Backup status (PMC Rule 8)
Windows : Failed Windows Backup Windows : Failed Windows Restores Windows : Successful Windows restore Windows : Successful Windows backup Recording on Internet Workstation, Server or Device Status (PMC Rule 4)
Windows : Registry Created Windows : Registry Deleted Windows : Registry Value Modified Reporting on The Status of The Audit System (PMC Rule 10)
Windows : Defender Malware Detection Windows : Defender Real Time Protection Detection Windows : DoS Attacks Windows : Downgrade Attacks Windows : Event Loggins Service Shutdown Windows : Event Logs Cleared Windows : IP Conficts Windows : Replay Attacks Windows : Security Logs Cleared Windows : Terminal Server Attacks Windows : User Account Locked Out Error Suspicious Internal Networks Activity (PMC Rule 5)
Windows : Audit Policy Changed Windows : Trusted Domain Created Windows : Trusted Domain Deleted Windows : Trusted Domain Modified Windows : User Right Assigned Windows : User Rights Removed `}),e.add({id:120,href:"/modules/siem/log_analytics/reports/compliance/hipaa/",title:"HIPAA",content:`In &lt;HIPAA&gt; there are 6 report templates.
164.308(a)(1)(ii)(D)
...
Windows : Failed Network Logons Windows : Failed User Logons Windows : Network Logoffs Windows : Network Logon Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : User Logoff Windows : User Logon 164.308(a)(6)(ii)
Windows : Failed Network Logons Windows : Failed User Logons Windows : Network Logoffs Windows : Network Logon Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : User Logoff Windows : User Logon 166.308(a)(7)(i)
Windows : AD Backup Error Windows : Audit Logs Cleared Windows : Error in EventLog Service Windows : Event log automatic backup Windows : Falied hotpatcing Windows : Failed software installations Windows : Failed software installations due to privilege mismatches Windows : New Service Installed Windows : Software Installed Windows : Software uninstalled Windows : Software updated Windows : Windows Startup and Windows Shutdown Account Logon Object Access `}),e.add({id:122,href:"/modules/alerts/historyalerts/",title:"History Alerts",content:`This gives an overview of the historical alert notifications based on the category selected. To go to History Alerts, click on &lt;Alerts&gt; on the Left Navigation Bar, then click &lt;Alerts&gt; on the Top Navigation Bar. Click on &lt;History&gt;.
Select the Alert category and the date range of the alerts that you would like to see.
`}),e.add({id:123,href:"/",title:"Homesss",content:`Welcome to NetGain docs!
...
NetGain Systems (c) 2002-2021. All rights reserved. `}),e.add({id:124,href:"/administrative/admin/elasticsearch/indices/",title:"Indices",content:`All performance data and logs are stored in Elasticsearch on a daily basis as indices.
...
`}),e.add({id:125,href:"/installation/emedge/emedge-agent/installation/",title:"Installation",content:`Supported environments emedge-agent is now supported on most common flavors Linux, Unix, Windows and Apple OSX.
...
Download and unzip latest emedge-agent software package for FreeBSD cd into emedge-agent folder and run emedge-agent config Installation as system service on unix/linux Linux/Unix/OSX: Run /opt/emedge-agent/emedge-agent service install Further details All logs will be saved into emedge-agent.log in the installation directory To stop emedge, simply run emedge-agent stop Note: run emedge-agent -h for more help on other commands `}),e.add({id:126,href:"/installation/emedge/installation/",title:"Installation",content:`To get started, select your platform Installation steps for emedge on Windows Download Windows MSI Installer for emedge Install via command line search for Command Prompt and right click &ldquo;Run as administrator&rdquo;.
run following command
...
`}),e.add({id:130,href:"/modules/alerts/integrations/",title:"Integrations",content:" Line notifications MSTeams notifications "}),e.add({id:131,href:"/administrative/admin/logs/internallog/",title:"Internal Logs",content:`Click on &lt;Internal logs&gt; in the Top navigation bar.
...
`}),e.add({id:132,href:"/administrative/tools/diagnostic/ipcalculator/",title:"IP Calculator",content:`This tool helps user to calculate IP address.
...
`}),e.add({id:133,href:"/modules/siem/log_analytics/reports/compliance/islp/",title:"ISLP",content:`In &lt;ISLP&gt; there are 8 report templates.
ARTICLE 12
...
Windows : Failed Windows backup Windows : Filed Windows restores Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Successful Windows restores Windows : Successful windows backup ARTICLE 30.4
Windows : Failed Windows backup Windows : Filed Windows restores Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Successful Windows restores Windows : Successful windows backup ARTICLE 30.6
Windows : Audit Policy Changed Windows : Failed Network Logons Windows : Failed User Logons Windows : Failed Windows backup Windows : Filed Windows restores Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Network Logoffs Windows : Network Logon Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Successful Windows restores Windows : Successful windows backup Windows : Terminal Server Disconnected Windows : Terminal Server Rconnected Windows : Trusted Domain Created Windows : Trusted Domain Deleted Windows : Trusted Domain Modified Windows : UnSuccessful Post Authentication Windows : UnSuccessful Pre Authentication Windows : User Logoff Windows : User Logon Windows : User Right Assigned Windows : User Rights Removed Windows : Windows Individual User Action `}),e.add({id:135,href:"/modules/siem/log_analytics/reports/compliance/iso27002013/",title:"ISO 2700 2013",content:`In &lt;ISO 27001 2013&gt; there are 6 report templates.
Control A 12.4.1
...
Windows : Computer Account Created Windows : Computer Account Deleted Windows : Computer Account Modified Windows : Group Created Windows : Group Deleted Windows : Group Modified Windows : User Account Created Windows : User Account Deleted Windows : User Account Locked Outs Windows : User Account Modified Windows : Windows Individual User Action `}),e.add({id:136,href:"/modules/siem/reports/compliance/iso27002013/",title:"ISO 2700 2013",content:`In &lt;ISO 27001 2013&gt; there are 6 report templates.
Control A 12.4.1
Windows : Audit Policy Changed Windows : Computer Account Created Windows : Computer Account Deleted Windows : Computer Account Modified Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Group Created Windows : Group Deleted Windows : Group Modified Windows : Trusted Domain Created Windows : Trusted Domain Deleted Windows : Trusted Domain Modified Windows : User Account Created Windows : User Account Deleted Windows : User Account Locked Outs Windows : User Account Modified Windows : User Right Assigned Windows : User Rights Removed Windows : Windows Individual User Action Control A 12.4.2
Windows : AD Backup Error Windows : Audit Logs Cleared Windows : Audit Policy Changed Windows : Error in EventLog Service Windows : Event log automatic backup Windows : Falied hotpatcing Windows : Failed software installations Windows : Failed software installations due to privilege mismatches Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : New Service Installed Windows : Software Installed Windows : Software uninstalled Windows : Software updated Windows : Trusted Domain Created Windows : Trusted Domain Deleted Windows : Trusted Domain Modified Windows : User Right Assigned Windows : User Rights Removed Windows : Windows Startup and Windows Shutdown Control A.12.4.3
Windows : Audit Policy Changed Windows : Computer Account Created Windows : Computer Account Deleted Windows : Computer Account Modified Windows : Failed Network Logons Windows : Failed User Logons Windows : Group Created Windows : Group Deleted indows : Group Modified Windows : Network Logoffs Windows : Network Logon Windows : Terminal Server Disconnected Windows : Terminal Server Rconnected Windows : Trusted Domain Created Windows : Trusted Domain Deleted Windows : Trusted Domain Modified Windows : User Account Created Windows : User Account Deleted Windows : User Account Locked Outs Windows : User Account Modified Windows : User Logoff Windows : User Logon Windows : User Right Assigned Windows : User Rights Removed Windows : Windows Individual User Action Control A 9.2.1
...
`}),e.add({id:139,href:"/modules/home/leftnavbar/",title:"Left Navigation Bar",content:`The Left Navigation Bar of the console let users access the different modules of NetGain Systems ITM&amp;SM and is always available throughout the console.
There is a small arrow at the base of the menu to expand the icon names.
Button Description Directs you to the home page of the spog.ai console, where you can access Dashboards, BizView and Maps. Lets users check the status or performance of devices or servers over a period of time. Also, where you can discover or add devices to be monitored. Optional SIEM module which includes Log Analytics and Security Analytics. Optional NetFlow module for network traffic details. Optional APM (Application Performance Management) module for application monitoring and management. Optional CMDB (Configuration management database) module for Asset Management, Network Configuration Management and IP Address Management. Lets you define alarms and how notification messages are to be sent to different IT team members. Built-in tools available on the spog.ai console, including sending pings and SNMP settings. System administrator functions, including adding / changing end-user information/settings. `}),e.add({id:140,href:"/administrative/admin/system/license/",title:"License",content:`License shows the user the details of the NetGain Systems Infrastructure Monitoring license information on enabled modules, used license nodes, total license nodes.
Click on the &lt;License&gt; in the Top Navigation Bar.
The page will show the info:
Serial number Infrastructure Monitoring model License Expiry date Max licensed nodes XXXX (currently used: XX) Max NetFlow Flow Rate XXX flows per sec Add-ons modules eg. Unlimited Ping, Network Config Manager, IP Address Manager, Asset Manager Advance monitors `}),e.add({id:141,href:"/troubleshooting_guides/FAQ/licensing/",title:"Licensing",content:`How to update license Click on Admin, System, License.
Choose the license file and click on to upload the license.
`}),e.add({id:142,href:"/modules/alerts/integrations/line/",title:"LINE notifications",content:`This document is to provide a step by step setup for Line App integration to be setup as the notifications channel
...
`}),e.add({id:143,href:"/modules/home/maps/logmap/",title:"Logical Map",content:`Logical Map allows the user to set various types of backgrounds so that there is a useful representation of the enterprise network and systems.
...
`}),e.add({id:144,href:"/administrative/admin/logs/",title:"Logs",content:`Click on &lt;Logs&gt; in the Top navigation bar.
System Logs Operation Logs Notification Logs Scheduler Logs Internal Logs Debug Logs `}),e.add({id:145,href:"/administrative/admin/elasticsearch/maintenance/",title:"Maintenance",content:`Click on &lt;Maintenance&gt; in the Top navigation bar.
...
Upload local backup: to upload a local backup copy to the system. Backup now: to do the configuration backup now. Download to local: to download the configuration as a zipped copy to the local drive. Restore: restore the configuration that you selected. Delete: delete the backup copy. `}),e.add({id:146,href:"/modules/netflow/settings_maintenance/maintenance/",title:"Maintenance",content:`The &lsquo;Performance&rsquo; tab displays various flow-related metrics and statistics for the network traffic being monitored and analyzed by the NetFlow system.
Information includes:
...
`}),e.add({id:147,href:"/modules/siem/log_analytics/mapping/",title:"Mapping",content:`NetGain Systems supports some log mapping by default. The common logs follows Common Event Format (CEF), and some other mappings supported by default are Aruba, Cisco, Fortinet logs etc.
...
`}),e.add({id:148,href:"/modules/metrics/metrics/",title:"Metrics Policy",content:`The module allows the user to configure or setup a policy for the devices and monitors. To access Policy module, click &lt;Metrics&gt; on the Left Navigation Bar then &lt;Policy&gt;.
Blackout Schedule SNMP V3 Users Global Rules Rules Audit `}),e.add({id:149,href:"/administrative/tools/diagnostic/mibbrowser/",title:"MIB Browser",content:`This tool helps user to load the devices’ MIBs file to NetGain Systems Infrastructure Monitoring server, to browse OID information and to allow user to know the particular OID of the device.
...
`}),e.add({id:150,href:"/modules/siem/mitreattack/",title:"MITRE ATT&CK",content:`MITRE ATT&amp;CK® is a globally-accessible knowledge base of adversary tactics and techniques based on real-world observations. The ATT&amp;CK knowledge base is used as a foundation for the development of specific threat models and methodologies in the private sector, in government, and in the cybersecurity product and service community.
...
`}),e.add({id:151,href:"/modules/siem/security_analytics/mitreattack/",title:"MITRE ATT&CK",content:`MITRE ATT&amp;CK® is a globally-accessible knowledge base of adversary tactics and techniques based on real-world observations. The ATT&amp;CK knowledge base is used as a foundation for the development of specific threat models and methodologies in the private sector, in government, and in the cybersecurity product and service community.
MITRE ATT&amp;CK is an information tab that allow user to link certain threats to the MITRE techniques ID. User can refer more info from this link: https://attack.mitre.org/
`}),e.add({id:152,href:"/modules/alerts/monitoralerts/",title:"Monitor Alerts",content:`NetGain Systems Infrastructure Monitoring uses the following color codes to distinguish between the different severity of alerts.
Color Severity Color Severity Red Critical Blue Warning Orange Major Green Normal Yellow Minor Gray Disabled `}),e.add({id:153,href:"/modules/metrics/monitor-business/",title:"Monitor by Business Types",content:`Business view is used to monitor the health and status of various business services within the system.
...
`}),e.add({id:154,href:"/modules/metrics/monitor-by-device-types/",title:"Monitor by Device Type",content:`Click on &lt;Metrics&gt; in the Left Navigation Bar, then &lt;Metrics&gt; in the Top Navigation Bar. Then click on &lt;Objects&gt; in the top menu, and click on &lt;Device view&gt;.
...
`}),e.add({id:155,href:"/troubleshooting_guides/FAQ/monitoringdiscovery/",title:"Monitoring & Discovery",content:`In Constructions
`}),e.add({id:156,href:"/modules/metrics/monitoralerts/",title:"Monitoring by Alert Types",content:`You can select the severity of the alerts at the top of the table to see those see the status of the devices that have the selected alert type. You can also make changes to the alert threshold settings.
...
`}),e.add({id:157,href:"/modules/alerts/integrations/msteams/",title:"MSTeams notifications",content:`This document is to provide a step by step setup for MS Teams integration to be setup as the notifications channel.
...
`}),e.add({id:158,href:"/administrative/admin/accounts/myprofile/",title:"My Profile",content:`This module allows you to change your current login user profile.
...
`}),e.add({id:159,href:"/modules/siem/log_analytics/reports/compliance/nerc/",title:"NERC",content:`In &lt;NERC&gt; there are 10 report templates.
CIP 005-6 R1.3
...
Windows : Windows Firewall Group Policy Changes Windows : Windows Firewall Rule Added Windows : Windows Firewall Rule Deleted Windows : Windows Firewall Rule Modified Windows : Windows Firewall Setting Changed Windows : Windows Firewall Setting Restored Windows : Windows Individual User Action CIP 009-6 R1.4
Windows : AD Backup Error Windows : Audit Logs Cleared Windows : Error in EventLog Service Windows : Event log automatic backup Windows : Failed Windows backup Windows : Filed Windows restores Windows : Falied hotpatcing Windows : Failed software installations Windows : Failed software installations due to privilege mismatches Windows : New Service Installed Windows : Service Failed Windows : Service Started Windows : Service Stopped Windows : Software Installed Windows : Software Uninstalled Windows : Software Updated Windows : Successful Windows restores Windows : Successful windows backup Windows : Windows Startup and Windows Shutdown CIP 010-2 R1.1
Windows : AD Backup Error Windows : Audit Logs Cleared Windows : Error in EventLog Service Windows : Event log automatic backup Windows : Exe or DLL File Allowed to Run Windows : Exe or DLL File Not Allowed to Run Windows : Exe or DLL Files Not Allowed to Run due to Enforced rules Windows : Falied hotpatcing Windows : Failed software installations Windows : Failed software installations due to privilege mismatches Windows : MSI Script File Allowed to Run Windows : MSI Script Files Not Allowed to Run due to Enforced rules Windows : New Service Installed Windows : Service Failed Windows : Service Started Windows : Service Stopped Windows : Software Installed Windows : Software Restricted to Access Program Windows : Software Uninstalled Windows : Software Updated Windows : Windows Startup and Windows Shutdown `}),e.add({id:161,href:"/modules/siem/log_analytics/reports/compliance/nist/",title:"NIST",content:`In &lt;NIST&gt; there are 2 report templates.
Account Logon
Data Security (PR.DS)
...
Windows : Threat Detections by Mcafee Windows : Threats Detection by Microsoft Antimalware Windows : Threats Detection by Norton AntiVirus Windows : Threats Detection by Sophos Anti-Virus Windows : Threats Detections by ESET Endpoint Antivirus `}),e.add({id:162,href:"/modules/siem/reports/compliance/nist/",title:"NIST",content:`In &lt;NIST&gt; there are 2 report templates.
Account Logon
Data Security (PR.DS)
Windows : Failed Network Logons Windows : Failed User Logons Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Network Logoffs Windows : Network Logon Windows : Removable Disk Creates Windows : Removable Disk Deletes Windows : Removable Disk Failed Creates Windows : Removable Disk Failed Deletes Windows : Removable Disk Failed Modifications Windows : Removable Disk Failed Reads Windows : Removable Disk Modifications Windows : Removable Disk Reads Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Terminal Server Disconnected Windows : Terminal Server Rconnected Windows : Unsuccessful Post Authentication Windows : Unsuccessful Pre Authentication Windows : User Logoff Windows : User Logon Windows : Windows Individual User Action Windows : Wireless Network Authentications Windows : Wireless Network Connected Windows : Wireless Network Disconnected Object Access Risk Assessment (ID.RA)
Windows : Threat Detections by Mcafee Windows : Threats Detection by Microsoft Antimalware Windows : Threats Detection by Norton AntiVirus Windows : Threats Detection by Sophos Anti-Virus Windows : Threats Detections by ESET Endpoint Antivirus `}),e.add({id:163,href:"/administrative/admin/logs/notificationlog/",title:"Notification Logs",content:`Click on &lt;Notification logs&gt; in the navigation bar.
It provides the history detailed records that how many notification messages been sent.
`}),e.add({id:164,href:"/modules/alerts/notificationrules/",title:"Notification Rules",content:`You can create Notification Rules to send SMS, email, 3rd party app messages, or audio and pop-up Windows alerts when your devices reach preset critical threshold levels. To create a Notification Rule, click on &lt;Alerts&gt; on the Left Navigation Bar, then click on &lt;Notifications&gt; on the Top Navigation Bar. Click on &lt;Rules&gt;, then &lt;+Create&gt;.
...
`}),e.add({id:165,href:"/modules/siem/log_analytics/reports/compliance/nrc/",title:"NRC",content:`In &lt;NRC&gt; there are 18 report templates.
ACT B.1.11
...
Windows : Failed Network Logons Windows : Failed User Logons Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Network Logoffs Windows : Network Logon Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : Unsuccessful Post Authentication Windows : Unsuccessful Pre Authentication Windows : User Logoff Windows : User Logon `}),e.add({id:166,href:"/modules/siem/reports/compliance/nrc/",title:"NRC",content:`In &lt;NRC&gt; there are 18 report templates.
ACT B.1.11
Windows : Failed Network Logons Windows : Failed User Logons Windows : Network Logoffs Windows : Network Logon Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Terminal Server Disconnected Windows : Terminal Server Rconnected Windows : UnSuccessful Post Authentication Windows : UnSuccessful Pre Authentication Windows : User Logoff Windows : User Logon ACT B.1.15
Windows : Failed Network Logons Windows : Failed User Logons Windows : Network Logoffs Windows : Network Logon Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Terminal Server Disconnected Windows : Terminal Server Rconnected Windows : Unsuccessful Post Authentication Windows : Unsuccessful Pre Authentication Windows : User Logoff Windows : User Logon ACT B.1.17
Windows : AD Backup Error Windows : Audit Logs Cleared Windows : Error in EventLog Service Windows : Event log automatic backup Windows : Falied hotpatcing Windows : Failed software installations Windows : Failed software installations due to privilege mismatches Windows : New Service Installed Windows : Software Installed Windows : Software Uninstalled Windows : Software Updated Windows : Windows Startup and Windows Shutdown Windows : Wireless Network Authentications Windows : Wireless Network Connected Windows : Wireless Network Disconnected ACT B.1.19
...
Windows : AD Backup Error Windows : Audit Logs Cleared Windows : Error in EventLog Service Windows : Event log automatic backup Windows : Falied hotpatcing Windows : Failed software installations Windows : Failed software installations due to privilege mismatches Windows : New Service Installed Windows : Software Installed Windows : Software Uninstalled Windows : Software Updated Windows : Windows Startup and Windows Shutdown ACT C.3.7
Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes ACT C.4.3
Windows : Failed Network Logons Windows : Failed User Logons Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Network Logoffs Windows : Network Logon Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : Unsuccessful Post Authentication Windows : Unsuccessful Pre Authentication Windows : User Logoff Windows : User Logon `}),e.add({id:167,href:"/administrative/admin/logs/operationlog/",title:"Operation Logs",content:`Click on &lt;Operation logs&gt; in the navigation bar.
It provides NetGain Systems Infrastructure Monitoring user login event, change of account or other Ops related events.
`}),e.add({id:168,href:"/modules/alerts/othersettings/",title:"Other Alert Notification Settings",content:`Besides Email and SMS notification, there are other methods to alert users, including 3rd party messaging apps such as Slack, MS Teams, WeChat, Alicloud, LINE and Telegram.
...
`}),e.add({id:169,href:"/modules/siem/log_analytics/reports/compliance/pcidss/",title:"PCI-DSS",content:`In &lt;PCI-DSS&gt; there are 6 report templates.
...
Windows : File Created Windows : File Deleted Windows : File Modified Windows : File Permission Changes `}),e.add({id:170,href:"/modules/siem/reports/compliance/pcidss/",title:"PCI-DSS",content:`In &lt;PCI-DSS&gt; there are 6 report templates.
PCI-DSS requirements 10.1
Windows : Failed Network Logons Windows : Failed User Logons Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Network Logoffs Windows : Network Logon Windows : Registry Created Windows : Registry Deleted Windows : Registry Value Modified Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : User Logoff Windows : User Logon Windows : Windows Individual User Action PCI-DSS requirements 10.2.1
Windows : Failed Network Logons Windows : Failed User Logons Windows : Network Logoffs Windows : Network Logon Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : User Logoff Windows : User Logon PCI-DSS requirements 10.2.2
Windows : Failed Network Logons Windows : Failed User Logons Windows : Network Logoffs Windows : Network Logon Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : User Logoff Windows : User Logon Windows : Windows Individual User Action PCI-DSS requirement 10.2.3
Windows : Audit Policy Changed Windows : Failed Network Logons Windows : Failed User Logons Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Network Logoffs Windows : Network Logon Windows : Registry Created Windows : Registry Deleted Windows : Registry Value Modified Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : Trusted Domain Created Windows : Trusted Domain Deleted Windows : Trusted Domain Modified Windows : User Logoff Windows : User Logon Windows : User Right Assigned Windows : User Rights Removed Windows : Windows Firewall Group Policy Changes Windows : Windows Firewall Rule Added Windows : Windows Firewall Rule Deleted Windows : Windows Firewall Rule Modified Windows : Windows Firewall Setting Changed Windows : Windows Firewall Setting Restored PCI-DSS requirements 10.2.6
Windows : AD Backup Error Windows : Audit Logs Cleared Windows : Error in EventLog Service Windows : Event log automatic backup Windows : Falied hotpatcing Windows : Failed software installations Windows : Failed software installations due to privilege mismatches Windows : New Service Installed Windows : Software Installed Windows : Software Uninstalled Windows : Software Updated Windows : Windows Startup and Windows Shutdown PCI-DSS requirements 10.2.7
Windows : File Created Windows : File Deleted Windows : File Modified Windows : File Permission Changes `}),e.add({id:171,href:"/modules/siem/log_analytics/reports/compliance/pdpa/",title:"PDPA",content:`In &lt;PDPA&gt; there are 2 report templates.
RULE VI Section 25
Windows : Failed Network Logons Windows : Failed User Logons Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Network Logoffs Windows : Network Logon Windows : Removable Disk Creates Windows : Removable Disk Deletes Windows : Removable Disk Failed Creates Windows : Removable Disk Failed Deletes Windows : Removable Disk Failed Modifications Windows : Removable Disk Failed Reads Windows : Removable Disk Modifications Windows : Removable Disk Reads Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : Unsuccessful Post Authentication Windows : Unsuccessful Pre Authentication Windows : User Logoff Windows : User Logon Windows : Windows Individual User Action Windows : Wireless Network Authentications Windows : Wireless Network Connected Windows : Wireless Network Disconnected RULE VII Section 30
Windows : Failed Network Logons Windows : Failed User Logons Windows : File Created Windows : File Deleted Windows : File Modified Windows : File Permission ChangesWindows : Network Logoffs Windows : Network Logon Windows : Removable Disk Creates Windows : Removable Disk Deletes Windows : Removable Disk Failed Creates Windows : Removable Disk Failed Deletes Windows : Removable Disk Failed Modifications Windows : Removable Disk Failed Reads Windows : Removable Disk Modifications Windows : Removable Disk Reads Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : UnSuccessful Post Authentication Windows : UnSuccessful Pre Authentication Windows : User Logoff Windows : User Logon Windows : Windows Individual User Action Windows : Wireless Network Authentications Windows : Wireless Network Connected Windows : Wireless Network Disconnected `}),e.add({id:172,href:"/modules/siem/reports/compliance/pdpa/",title:"PDPA",content:`In &lt;PDPA&gt; there are 2 report templates.
RULE VI Section 25
Windows : Failed Network Logons Windows : Failed User Logons Windows : File Crated Windows : File Deleted Windows : File Modified Windows : File Permission Changes Windows : Network Logoffs Windows : Network Logon Windows : Removable Disk Creates Windows : Removable Disk Deletes Windows : Removable Disk Failed Creates Windows : Removable Disk Failed Deletes Windows : Removable Disk Failed Modifications Windows : Removable Disk Failed Reads Windows : Removable Disk Modifications Windows : Removable Disk Reads Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : Unsuccessful Post Authentication Windows : Unsuccessful Pre Authentication Windows : User Logoff Windows : User Logon Windows : Windows Individual User Action Windows : Wireless Network Authentications Windows : Wireless Network Connected Windows : Wireless Network Disconnected RULE VII Section 30
Windows : Failed Network Logons Windows : Failed User Logons Windows : File Created Windows : File Deleted Windows : File Modified Windows : File Permission ChangesWindows : Network Logoffs Windows : Network Logon Windows : Removable Disk Creates Windows : Removable Disk Deletes Windows : Removable Disk Failed Creates Windows : Removable Disk Failed Deletes Windows : Removable Disk Failed Modifications Windows : Removable Disk Failed Reads Windows : Removable Disk Modifications Windows : Removable Disk Reads Windows : Successful Post Authentication Windows : Successful Pre Authentication Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : UnSuccessful Post Authentication Windows : UnSuccessful Pre Authentication Windows : User Logoff Windows : User Logon Windows : Windows Individual User Action Windows : Wireless Network Authentications Windows : Wireless Network Connected Windows : Wireless Network Disconnected `}),e.add({id:173,href:"/administrative/tools/diagnostic/ping/",title:"Ping",content:`This tool helps user to verify the connectivity between NetGain Systems Infrastructure Monitoring server and the destination devices.
...
`}),e.add({id:174,href:"/troubleshooting_guides/FAQ/reporting/",title:"Report",content:`In Construction
`}),e.add({id:175,href:"/modules/apm/reports/",title:"Reports",content:`The report module is used to generate ad-hoc reports. This module supports:
...
Once done, click on ‘Save’.
`}),e.add({id:176,href:"/modules/netflow/reports/",title:"Reports",content:`You can create different NetFlow reports based on different search expressions.
...
`}),e.add({id:177,href:"/modules/siem/log_analytics/reports/",title:"Reports",content:`To access the SIEM Reports function, click on the &lt;SIEM&gt; icon at the Left Navigation Bar then click on &lt;Reports&gt; at the Top Navigation Bar.
There are 4 sub-menus in the Reports function:
Common Applications Compliance Ad Hoc `}),e.add({id:178,href:"/modules/siem/reports/",title:"Reports",content:`To access the SIEM Reports function, click on the &lt;SIEM&gt; icon at the Left Navigation Bar then click on &lt;Reports&gt; at the Top Navigation Bar.
There are 4 sub-menus in the Reports function:
Common Applications Compliance Ad Hoc `}),e.add({id:179,href:"/administrative/admin/system/restapis/",title:"Rest APIs",content:`This module describes the REST API and resources provided by NetGain Systems Infrastructure Monitoring.
Click on &lt;Rest APIs&gt; in the navigation bar.
`}),e.add({id:180,href:"/administrative/admin/accounts/roles/",title:"Roles",content:`The Administrator can control the newly created user’s access right through Roles. To create new role for the End-User. Click on &lt;+Create&gt; in the page.
...
`}),e.add({id:181,href:"/modules/metrics/metrics/rulesaudit/",title:"Rules Audit",content:`User will be able to determine the standardization of the threshold parameters. It lets the user merge the old settings to new settings to make it standard.
...
`}),e.add({id:182,href:"/modules/home/dashboards/savedashboard/",title:"Saving Dashboard",content:`Click on the button at the corner to save the dashboard.
`}),e.add({id:183,href:"/administrative/admin/logs/schedulerlog/",title:"Scheduler Logs",content:`Click on &lt;Scheduler logs&gt; in the Top navigation bar.
It shows the scheduler running history logs:
`}),e.add({id:184,href:"/modules/cmdb/schedulingbackup/",title:"Scheduling Configuration Backup",content:`This lets you schedule the backup of your Network Configuration. Click on &lt;Schedules&gt; at the top menu of &lt;Network Config&gt;.
...
`}),e.add({id:185,href:"/modules/siem/log_analytics/schema/",title:"Schema",content:`This is information tab about Elastic Common Schema. User can get more from the following link: https://www.elastic.co/guide/en/ecs/current/index.html
`}),e.add({id:186,href:"/modules/siem/log_analytics/search/",title:"Search",content:`SIEM search is for the user to do simple search through keywords or to do advance query string search. Example simple search:
...
`}),e.add({id:187,href:"/modules/siem/search/",title:"Search",content:`The search function here is like the search bar on Log Analytics. User can do simple search or advance query string on the logs that recorded threat. &lt;Help&gt; can be used to learn more about the query syntax.
User can select the time range and look at the number of threat logs on different time range.
`}),e.add({id:188,href:"/modules/siem/security_analytics/search/",title:"Search",content:`The search function here is like the search bar on Log Analytics. User can do simple search or advance query string on the logs that recorded threat. &lt;Help&gt; can be used to learn more about the query syntax.
User can select the time range and look at the number of threat logs on different time range.
`}),e.add({id:189,href:"/troubleshooting_guides/FAQ/security/",title:"Security",content:`How to request CSR generation Please change the following details according to customer requirements.
...
Event.outcome Host.ip Transaction.duration.us Source.ip User OS Transaction type User browser `}),e.add({id:191,href:"/installation/cloud_vista/setting-up/",title:"Setting up",content:"Getting up and running Signup for at CVS account at https://portal.netgain-systems.com/signup Login to your portal at https://portal.netgain-systems.com/login to create your CVS instance Install and setup emedge at local site(s) by following steps in this page Optionally install emedge-agent software on your server hosts that you would like to manage, with these steps Once done, monitoring metrics, logs and traffic data will now be automatically streamed to the assigned CVS instance "}),e.add({id:192,href:"/modules/netflow/settings_maintenance/",title:"Settings and Maintenance",content:`To navigate to NetFlow settings, click &lt;NetFlow&gt; on the Left navigation bar then &lt;Settings&gt;.
Applications Maintenance `}),e.add({id:193,href:"/administrative/admin/elasticsearch/shards/",title:"Shards",content:`Click on &lt;Shards&gt; in the Top navigation bar.
...
`}),e.add({id:194,href:"/troubleshooting_guides/FAQ/snmpinstall/",title:"SNMP Installation & Configuration",content:`How to discover monitors through SNMPV3 Click on Metrics, Discover.
...
`}),e.add({id:195,href:"/modules/metrics/metrics/snmpv3users/",title:"SNMP V3 Users",content:`The SNMP v3 user credentials can be set here.
Click &lt;Metrics&gt; on the Left navigation bar then &lt;Policy&gt;. Under &lt;SNMP v3 Users&gt; click &lt;Add new user&gt;.
`}),e.add({id:196,href:"/administrative/tools/diagnostic/snmpwalk/",title:"SNMPWALK",content:`This tool helps user to test the SNMP connectivity between NetGain Systems EM server to the destination devices and get the SNMP.
...
`}),e.add({id:197,href:"/modules/siem/log_analytics/sources/",title:"Sources",content:`This section enables the user to add logs into the system.
...
`}),e.add({id:198,href:"/modules/siem/log_analytics/reports/compliance/sox/",title:"SOX",content:`In &lt;SOX&gt; there are 7 report templates.
SEC 302(a)(4)(A)
...
Windows : Computer Account Created Windows : Computer Account Deleted Windows : Computer Account Modified Windows : Group Created Windows : Group Deleted Windows : Group Modified Windows : User Account Created Windows : User Account Deleted Windows : User Account Locked Outs Windows : User Account Modified `}),e.add({id:199,href:"/modules/siem/reports/compliance/sox/",title:"SOX",content:`In &lt;SOX&gt; there are 7 report templates.
SEC 302(a)(4)(A)
Windows : AD Backup Error Windows : Audit Logs Cleared Windows : Error in EventLog Service Windows : Event log automatic backup Windows : Falied hotpatcing Windows : Failed software installations Windows : Failed software installations due to privilege mismatches Windows : New Service Installed Windows : Process Accessed Windows : Process Created Windows : Process Duplicated Windows : Process Terminated Windows : Software Install Windows : Software Uninstalled Windows : Software Updated Windows : Windows Startup and Windows Shutdown SEC 302(a)(4)(b)
Windows : Audit Policy Changed Windows : Trusted Domain Created Windows : Trusted Domain Deleted Windows : Trusted Domain Modified Windows : User Right Assigned Windows : User Rights Removed SEC 302(a)(4)(C)
Windows : Failed Network Logons Windows : Failed User Logons Windows : Network Logoffs Windows : Network Logon Windows : Terminal Server Disconnected Windows : Terminal Server Reconnected Windows : User Logoff Windows : User Logon SEC 302(a)(4)(D)
...
`}),e.add({id:202,href:"/administrative/admin/system/",title:"System",content:`System page allows End-User to see the overview of logs on the NetGain Systems Infrastructure Monitoring systems, system diagnostics to check on the system for error and system uptime.
Status License Rest APIs `}),e.add({id:203,href:"/administrative/admin/logs/systemlog/",title:"System Logs",content:`The End-User can quickly download Infrastructure Monitoring system related logs such as System Log, Operation Log, Vista logs, Notifications log, Scheduler log, Internal log, and Debug log as text files or Excel file for analysis.
...
`}),e.add({id:204,href:"/tags/",title:"Tags",content:""}),e.add({id:205,href:"/modules/siem/security_analytics/threatdetection/",title:"Threat Detection",content:`By default, NetGain Systems support around 500 detection rules. Detection rules are done through the query string.
...
`}),e.add({id:206,href:"/modules/siem/threatdetection/",title:"Threat Detection",content:`By default, NetGain Systems support around 500 detection rules. Detection rules are done through the query string.
For default rule, user can &lt;Disable&gt;, &lt;Enable&gt; and &lt;Edit&gt; the tags or description (but not query expression) in the edit.
To add new rule, user can add in &lt;Add new rule&gt;. User just need to specific the name, tags, description accordingly.
User can define the &lt;interval&gt; on how frequent for SIEM to run through this rule. For &lt;search window&gt; under logic type query, user can define the historical search window.
NetGain Systems supports 3 types of logic type: Python(sandbox), Query and Workflow to create new rules.
Python: Python API documentation is available in the GUI Query: Using search query or query expression. Workflow: Flow chart type logic. The workflows can be created in the &lt;AI Workflows&gt; Threat Intelligence &amp; Lookup Tables Threat Intelligence is where NetGain Systems gather the flagged IP or URL from establish sources and compare against the logs. User can choose to enable or disable particular sources.
For lookup tables, user can use it to create table to map key to a value. The key can be used in python script to run certain rules.
`}),e.add({id:207,href:"/modules/siem/security_analytics/threatevents/",title:"Threat Events",content:`In Threat Events, user can search for the threat events based on their threat ID or threat message. Clicks on the events will bring up all the related log that linked to this threat.
User can also select the different time range to check for the events that happened.
`}),e.add({id:208,href:"/modules/siem/threatevents/",title:"Threat Events",content:`In Threat Events, user can search for the threat events based on their threat ID or threat message. Clicks on the events will bring up all the related log that linked to this threat.
User can also select the different time range to check for the events that happened.
`}),e.add({id:209,href:"/modules/metrics/thresholdsettings/",title:"Threshold Settings",content:`Click on &lt;Metrics&gt; in the Left Navigation Bar, then &lt;Metrics&gt; in the Top Navigation Bar. Then click on &lt;Objects&gt; in the top menu, and click on &lt;Device view&gt;. To adjust the threshold settings, click on the device type / device on the right side of the table and drill down till you see the monitoring parameter you would like to change. Click &lt;Edit&gt; to enable the edit mode and click the – Change threshold settings icon to edit the threshold settings.
...
`}),e.add({id:210,href:"/modules/siem/log_analytics/reports/adhoc/addreport/",title:"To add a new report",content:`Click &lt;+Add new report&gt;.
...
Save – Save report
`}),e.add({id:211,href:"/modules/siem/reports/adhoc/addreport/",title:"To add a new report",content:`Click &lt;+Add new report&gt;.
Report title – Enter report title.
Category – Enter report category.
Description – Enter description of report.
Search expression – Enter search expression.
Visibility – Select who can see this report (Owner/All)
Save – Save report
`}),e.add({id:212,href:"/modules/siem/log_analytics/reports/adhoc/autodelivery/",title:"To create auto delivery report setting",content:`
...
Save – Save report
`}),e.add({id:213,href:"/modules/siem/reports/adhoc/autodelivery/",title:"To create auto delivery report setting",content:`
Mail Subject – enter mail subject.
Mail Body – Enter mail body.
Target Address (s) – Enter email address.
Format – Select report file type. (Excel/PDF)
...
Hour of day – Enter number of hour
Save – Save report
`}),e.add({id:214,href:"/modules/siem/log_analytics/reports/adhoc/downloadreport/",title:"To download report",content:`Download Excel – Download report to local computer in Excel file.
Download PDF – Download report to local computer in PDF file.
Download CSV – Download report to local compute in SCV file
`}),e.add({id:215,href:"/modules/siem/reports/adhoc/downloadreport/",title:"To download report",content:`Download Excel – Download report to local computer in Excel file.
Download PDF – Download report to local computer in PDF file.
Download CSV – Download report to local compute in SCV file
`}),e.add({id:216,href:"/modules/siem/log_analytics/reports/adhoc/editreport/",title:"To edit report",content:`
Report title – Enter report title.
Category – Enter report category.
Description – Enter description of report.
Search expression – Enter search expression.
...
Save – Save report
`}),e.add({id:217,href:"/modules/siem/reports/adhoc/editreport/",title:"To edit report",content:`
Report title – Enter report title.
Category – Enter report category.
Description – Enter description of report.
Search expression – Enter search expression.
...
Delete report – Delete report
Save – Save report
`}),e.add({id:218,href:"/administrative/tools/",title:"Tools",content:`NetGain Systems Infrastructure Monitoring provides diagnostic tools for troubleshooting and agents for installation on the servers that needs to be monitored. Click on &lt;Tools&gt; at the left navigation bar.
Diagnostic Agent Download `}),e.add({id:219,href:"/modules/home/topnavbar/",title:"Top Navigation Bar",content:`The Top Navigation Bar displays different functions, depending on the module selected from the Left Navigation Bar. The current selected function will be underlined. For the Home Page, the available functions are:
Dashboards: for default dashboards as well customizable dashboards to display. BizViews: to view the services availability, status and performance from a business or services perspectives. Maps: to view devices status from a logical, physical or geographic view. `}),e.add({id:220,href:"/troubleshooting_guides/FAQ/user_management/",title:"User Management",content:`How to unlock my user account if its locked Admin account is needed in order to unlock user’s account.
...
Change the input to the desired days. `}),e.add({id:221,href:"/administrative/admin/accounts/users/",title:"Users",content:`You can specify different access rights for different roles, for example, specifying that business staff only receive system warnings but not able to perform operations. Different access rights will affect the administrative rights you have, and thus access to features in the Administrator interface.
...
`}),e.add({id:222,href:"/modules/netflow/usingnta/",title:"Using Network Traffic Analytics",content:`The &lsquo;Overview&rsquo; tab displays the general summary of network traffic data.
...
`}),e.add({id:223,href:"/modules/apm/watcher/",title:"Watcher",content:`APM Watcher is used to watch out for specified data within APM. The system generates an alarm when the data contains the specified query string. This is useful for identifying problems quickly.
...
`}),e.add({id:226,href:"/modules/siem/watcher/",title:"Watcher",content:`This function is used to watch out for specified data within incoming data logs. The system sends an alarm when the incoming log data contains a specified key word or phrase. This is useful to detect any known abnormalities or behavior.
To access the Watcher function, click on the &lt;SIEM&gt; icon at the Left Navigation Bar then click on &lt;Watcher&gt; at the Top Navigation Bar if not already at the Reports page.
Add Watcher Rule Click on Watcher &lt; &gt; and when you are in the Watcher menu, click .
Enter the data and rules to define what you want to watch out for and receive an alarm when the conditions are met.
Name – Input name of rule.
...
To view LogWatch alerts When the Watcher rule has been created and enabled, an alert will be generated if the specified key word or phrase is detected.
To see the alert message, click on Alerts icon at the Left Bavigation bar then click on &lt;Alerts&gt; at the Top Navigation Bar than click on &lt;Current&gt; at the sub menu bar then select &lt;LogsWatch Alarms&gt; at the drop down list menu.
`}),e.add({id:227,href:"/modules/home/dashboards/widgetdetails/",title:"Widget Details",content:` Category Widget Name Description Logs Histogram Query string driven. Shows logs histogram by different aggregation methods in the form of bar, line and area graphs.
