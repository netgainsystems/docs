...
Left Navigation Top Navigation Dashboards Maps Business Views `}),e.add({id:9,href:"/modules/test/",title:"Test",content:`This is a test main category page.
Test Page `}),e.add({id:10,href:"/installation/cloud_vista/",title:"Cloud Vista",content:`Cloud Vista Suite (CVS) by NetGain Systems is a scalable monitoring service for hybrid cloud environments, providing monitoring of networks, servers, databases, applications, and services, through a SaaS-based monitoring analytics platform
...
`}),e.add({id:206,href:"/tags/",title:"Tags",content:""}),e.add({id:207,href:"/modules/home/testpage/",title:"Test Page",content:`This is a test page.
Test 1 Test 2 Test 3 `}),e.add({id:208,href:"/modules/siem/security_analytics/threatdetection/",title:"Threat Detection",content:`By default, NetGain Systems support around 500 detection rules. Detection rules are done through the query string.
...
Dashboards: for default dashboards as well customizable dashboards to display. BizViews: to view the services availability, status and performance from a business or services perspectives. Maps: to view devices status from a logical, physical or geographic view. `}),e.add({id:223,href:"/modules/test/topnavbar/",title:"Top Navigation Bar",content:`The Top Navigation Bar displays different functions, depending on the module selected from the Left Navigation Bar. The current selected function will be underlined. For the Home Page, the available functions are:
