...
- **Windows Filesystem Cache**
  ...
  - **Windows - Windows Filesystem Cache - PinReadsPersec**
      ...
      Rate of reading data into the file system cache preparatory to writing the data back to disk. Pages read in this fashion are pinned in memory at the completion of the read. While pinned, a page's physical address in the file system cache will not be altered
...
## NsFocus IPS
- **Network**
  - **NsFocus IPS - Network - Packages** (pkts/s)
  ...
  - **NsFocus IPS - Network - Bytes** (bytes/s)
      ...
      Bytes per Second
- **CPU**
  - **NsFocus IPS - CPU - Utilization** (%)

      CPU usage
- **Session**
  - **NsFocus IPS - Session - Count** (sessions/s)

      Tcp sessions rate
- **Disk**
  - **NsFocus IPS - Disk - Size** (GB)

      Available storage space
- **NsFocus IPS**
- **Memory**
  - **NsFocus IPS - Memory - Utilization** (%)
...
- **Temperature**
  - **Juniper - Temperature - Temperature** (C)

      
- **VPN Memory**
  - **Juniper - VPN Memory - Utilization** (%)

      
- **NetScreen**
- **Slot Status**
  - **Juniper - Slot Status - Status**
...
- **Anti-virus stats**
  ...
  - **Juniper - Anti-virus stats - Protected**
      ...
      No. of requests can't be scanned due to protected by password
  - **Juniper - Anti-virus stats - Decompress**

      No. of requests can't be scanned due to exceeding max decmopress layer
  - **Juniper - Anti-virus stats - Corrupted**

      No. of requests can't be scanned due to file corrupted
  - **Juniper - Anti-virus stats - NoResource**

      No. of requests can't be scanned due to out-of-resource
  - **Juniper - Anti-virus stats - InternalError**

      No. of requests can't be scanned due to internal error
  - **Juniper - Anti-virus stats - MaxContentSize**

      No. of requests can't be scanned due to exceeding max content size
  - **Juniper - Anti-virus stats - TooManyReq**

      No. of requests can't be scanned due to exceeding maximum requests limit
  - **Juniper - Anti-virus stats - Timeout**

      No. of requests can't be scanned due to scan timeout
  - **Juniper - Anti-virus stats - EngineNotReady**

      No. of requests can't be scanned due to scan engine not ready
- **IDP Stats**
...
- **VPN CPU**
  - **Juniper - VPN CPU - CPU Utilization** (%)
...
## Palo Alto
- **HA Mode**
  - **Palo Alto - HA Mode - Mode**

      Current high-availability mode
- **Global Drop Counters**
  - **Palo Alto - Global Drop Counters - FwdL3Ttl**
...
- **Gateway Utilization**
  - **Palo Alto - Gateway Utilization - Utilization percentage**
...
- **DOS Global Counters**
  - **Palo Alto - DOS Global Counters - AgMaxSessLimit**
...
- **HA Peer State**
  - **Palo Alto - HA Peer State - HA Peer State**

      Current peer high-availability state
- **HA State**
  - **Palo Alto - HA State - State**

      Current high-availability state
- **Global TcpState Counters**
  - **Palo Alto - Global TcpState Counters - TcpAllocWqeFail**
...
- **Global Counters**
  - **Palo Alto - Global Counters - PanAhoSW**
...
- **Palo Alto**
- **Global Ip Fragmentation Counters**
  - **Palo Alto - Global Ip Fragmentation Counters - FlowIpFragErr**
...
## McAfee
- **Failover Status**
  - **McAfee - Failover Status - Status**

      System Failover status
- **Health Status**
  - **McAfee - Health Status - Status**

      System Health status
- **Temparature Status**
  - **McAfee - Temparature Status - Status**

      Temparature Status
- **Failover Action**
  - **McAfee - Failover Action - Action**

      System Failover action
- **Uptime**
  - **McAfee - Uptime - System Uptime**

      System uptime
- **EMS Entry**
  - **McAfee - EMS Entry - Priority**
...
- **Disk**
  - **McAfee - Disk - Size** (GB)
      ...
      Available storage space
- **Failover Mode**
  - **McAfee - Failover Mode - Mode**

      System Failover mode
- **Response Port Entry**
  - **McAfee - Response Port Entry - Description**
...
- **Packet Log Channel Status**
  - **McAfee - Packet Log Channel Status - Status**

      Packet log channel status
- **Sensor Packet Count**
  - **McAfee - Sensor Packet Count - Packet Fwd Count**
...
- **Sensor Performance**
  - **McAfee - Sensor Performance - Avg Load**
...
- **Fail open Action**
  - **McAfee - Fail open Action - Action**

      System Fail open action
- **Fan Status**
  - **McAfee - Fan Status - Status**

      Fan Status
- **Alert Channel Status**
  - **McAfee - Alert Channel Status - Status**

      System alert channel status
- **Malware**
  - **McAfee - Malware - Primary DNS Server**
  ...
  - **McAfee - Malware - UDF Detection mode**
      ...
      UDF detection mode
- **Sensor Packet Drop**
  - **McAfee - Sensor Packet Drop - Rate Limit Pkt Drop**
...
- **McAfee**
- **TCP Perf Entry**
  - **McAfee - TCP Perf Entry - Max Flows**
...
- **Power supply**
  - **McAfee - Power supply - Primary power supply status**

      Primary power supply Status
  - **McAfee - Power supply - Secondary power supply status**

      Secondary power supply Status
- **Malware Counter Entry**
  - **McAfee - Malware Counter Entry - Total queries**
  ...
  - **McAfee - Malware Counter Entry - Unknown Error**
      ...
      Unknown Error
- **Sensor Memory Usage**
  - **McAfee - Sensor Memory Usage - Avg TCP UDP Flow**
...
- **Memory**
  - **SonicWall - Memory - Utilization** (%)

      
- **CPU**
  - **SonicWall - CPU - Utilization** (%)
...
- **Node Interface**
  - **IBM - Node Interface - State**

      
- **Server Log**
  - **IBM - Server Log - Result**

      
- **LotusNotes ServerTask**
  - **IBM - LotusNotes ServerTask - Task Count** (tasks)
...
- **.NET CLR Memory**
  ...
  - **Microsoft - .NET CLR Memory - FinalizationSurvivors**
      ...
      No. of garbage collected objects that survive a collection because they are waiting to be finalized. If these objects hold references to other objects then those objects also survive but are not counted by this counter; the 'Promoted Finalization-Memory from Gen 0' and 'Promoted Finalization-Memory from Gen 1' counters represent all the memory that survived due to finalization. This counter is not a cumulative counter; its updated at the end of every GC with count of the survivors during that particular GC only. This counter was designed to indicate the extra overhead that the application might incur because of finalization
  ...
  - **Microsoft - .NET CLR Memory - NumberGen2Collections**
      ...
      No. of times the generation 2 objects (older) are garbage collected since the start of the application. The counter is incremented at the end of a Gen 2 GC (also called full GC). _Global_ counter value is not accurate and should be ignored. This counter displays the last observed value
...
- **MS Active Directory Service**
  ...
  - **Microsoft - MS Active Directory Service - DSNameCachehitrate** (%)
      ...
      % of directory object name component look ups that are satisfied out of the DSA's name cache
...
- **Application Pool Status**
  - **Microsoft - Application Pool Status - Status**
...
- **.NET CLR Locks and threads**
  ...
  - **Microsoft - .NET CLR Locks and threads - TotalNumberofContentions**
      ...
      Total no. of times threads in the CLR have attempted to acquire a managed lock unsuccessfully. Managed locks can be acquired in many ways; by the 'lock' statement in C# or by calling System.Monitor.Enter or by using MethodImplOptions.Synchronized custom attribute
- **Site Status**
  - **Microsoft - Site Status - Status**
...
- **Worker Process Status**
  - **Microsoft - Worker Process Status - Status**
...
- **.NET CLR Jit**
  ...
  - **Microsoft - .NET CLR Jit - NumberofILBytesJitted**
      ...
      Total IL bytes jitted since the start of the application. This counter is exactly equivalent to the 'Total # of IL Bytes Jitted' counter
  ...
  - **Microsoft - .NET CLR Jit - TotalNumberofILBytesJitted**
      ...
      Total IL bytes jitted since the start of the application. This counter is exactly equivalent to the '# of IL Bytes Jitted' counter
## JBoss
- **Connection Pool**
...
- **Hyper-V Virtual Switch**
  - **HyperV - Hyper-V Virtual Switch - BytesPersec** (B)

      
- **Memory Vid Partition**
...
## Sybase
- **Ping Connection Caches**
  - **Sybase - Ping Connection Caches - State**

      
- **Service State**
  - **Sybase - Service State - State**
...
- **HP**
- **HP-UX Cluster**
  - **HP - HP-UX Cluster - cluster_status**
...
- **Processors Sensor**
  - **Vmware - Processors Sensor - State**

      
- **Memory Sensor**
  - **Vmware - Memory Sensor - State**
...
- **SMTP**
  - **Internet Service - SMTP - Response Time** (ms)
...
- **TFTP**
  - **Internet Service - TFTP - Response Time** (ms)

      
- **IMAP**
  - **Internet Service - IMAP - Response Time** (ms)
...
- **POP3**
  - **Internet Service - POP3 - Response Time** (ms)

      
- **News**
  - **Internet Service - News - Response Time** (ms)
...
- **NetBackup**
- **Tape Status**
  - **Veritas - Tape Status - Tape Drive Status**
...
## Service Monitor
- **Service Monitor**
  - **Service Monitor - Service Monitor - Success Monitor Count**
...
## Active-Standby Monitor
- **Active-Standby Monitor**
  - **Active-Standby Monitor - Active-Standby Monitor - Active Up - Standby Up**
...
- **Ping Service Monitor**
  - **Ping Service Monitor - Ping Service Monitor - Total Count**
...
## Virtual Process Monitor
- **Virtual Process Monitor**
  - **Virtual Process Monitor - Virtual Process Monitor - Success Monitor Count**
...
- **JDBC**
- **Long Transaction**
  - **Informix - Long Transaction - Count**
...
- **Checkpoint**
  - **Informix - Checkpoint - Latest duration** (s)
...
- **TCP Listener States**
  - **MS-SQL - TCP Listener States - State**
...
- **SQL Errors**
  - **MS-SQL - SQL Errors - Errors/sec** (/s)
...
## CacheDB
- **Performance Info**
  - **CacheDB - Performance Info - Lines**
  ...
  - **CacheDB - Performance Info - GThrottleCur**
      ...
      Num of jobs currently counted 'in global'
  - **CacheDB - Performance Info - GThrottleMax**

      The maximum num of jobs to allow 'in global'
...
- **System Status**
  - **CacheDB - System Status - Used license**
...
- **CacheDB**
- **Buffer Info**
  - **CacheDB - Buffer Info - Utilization** (%)
...
- **DB Health**
  - **PostgreSQL - DB Health - Health** (%)

      
- **Buffers**
  - **PostgreSQL - Buffers - Refresh Time** (ms)
...
- **PostgreSQL**
- **Cache**
  - **PostgreSQL - Cache - Cache Usage** (MB)
...
- **Agent**
- **Abnormal Connection**
  - **Oracle - Abnormal Connection - count**
...
- **Parallel Query Usage**
  - **Oracle - Parallel Query Usage - utilization** (%)
...
- **MemtablePool**
  - **Cassandra - MemtablePool - BlockedOnAllocation**
...
- **Client**
  - **Cassandra - Client - ConnectedNativeClients**
...
- **Temperature**
  - **NetApp - Temperature - Status**

      
- **Memory**
  - **NetApp - Memory - Utilization** (%)
...
- **Drive Channel IO**
  - **IBM - Drive Channel IO - Total IO count**

      
- **Enclosure SFP**
  - **IBM - Enclosure SFP - Status**
...
- **Controller Drive Interface**
  - **IBM - Controller Drive Interface - Status**

      
- **Drive Channel Status**
  - **IBM - Drive Channel Status - Status**

      
- **Enclosure Fan**
  - **IBM - Enclosure Fan - Status**
...
- **Missing Logical Drives**
  - **IBM - Missing Logical Drives - Missing**

      
- **Global Status**
  - **IBM - Global Status - Status**
...
- **Enclosure Power Supply**
  - **IBM - Enclosure Power Supply - Status**
...
- **Controller Ethernet Port**
  - **IBM - Controller Ethernet Port - Status**
...
- **PowerSupply**
  - **IBM - PowerSupply - status**

      
- **Enclosure Temperature**
  - **IBM - Enclosure Temperature - Status**
...
- **Controller Host Interface**
  - **IBM - Controller Host Interface - Status**
...
- **Cache Backup Device**
  - **IBM - Cache Backup Device - Status**
...
- **Shutdown State**
  - **ADIC - Shutdown State - Shutdown State**

      
- **Robotics**
  - **ADIC - Robotics - Status**
...
- **Startup State**
  - **ADIC - Startup State - Startup State**
...
- **Error Code**
  - **ADIC - Error Code - Error Code**

      
- **Global Status**
  - **ADIC - Global Status - Global Status**
...
- **Hitachi Array Unit Drive**
  - **Hitachi - Hitachi Array Unit Drive - Status**

      
- **Hitachi USP**
- **Hitachi Array Unit Loop**
  - **Hitachi - Hitachi Array Unit Loop - Status**

      
- **Hitachi Array Unit Fan**
  - **Hitachi - Hitachi Array Unit Fan - Status**

      
- **Hitachi Array Unit Battery**
  - **Hitachi - Hitachi Array Unit Battery - Status**

      
- **Hitachi Array Raid Drive**
  - **Hitachi - Hitachi Array Raid Drive - Status**

      
- **Hitachi Array Unit Host Connector**
  - **Hitachi - Hitachi Array Unit Host Connector - Status**

      
- **Hitachi Array Unit**
- **Hitachi**
- **Hitachi Array Unit Cache**
  - **Hitachi - Hitachi Array Unit Cache - Status**

      
- **Hitachi Array Unit AC**
  - **Hitachi - Hitachi Array Unit AC - Status**
...
- **Hitachi Array Unit Enclosure**
  - **Hitachi - Hitachi Array Unit Enclosure - Status**
...
- **TSM Path**
  - **TSM - TSM Path - Online Status**

      
- **TSM Drive**
  - **TSM - TSM Drive - Online Status**
...
- **Fan**
  ...
  - **Huawei - Fan - RunningLevel**
      ...
      Fan speed level.
- **Controller**
  - **Huawei - Controller - ControllerID**
...
- **Logical Component Module**
- **Storage Tier**
  - **Huawei - Storage Tier - TierID**
...
- **Front End Host Port**
  - **Huawei - Front End Host Port - IfIndex**
...
- **Sensors**
  - **iBoot-PDU - Sensors - voltageLC1** (V)
...
- **Cluster Members**
  - **F5 - Cluster Members - Total cluster members**

      
- **TMM server-side connections**
...
- **TMM client-side connections**
  ...
  - **F5 - TMM client-side connections - Max**
      ...
      Maximum connections from client-side
- **CPU Temperature**
  - **F5 - CPU Temperature - Temperature** (C)
...
- **Chassis Temperature**
  - **F5 - Chassis Temperature - Temperature** (C)
...
- **Airespace CPU**
  - **Cisco - Airespace CPU - Utilization** (%)
...
- **Jitter**
  - **Cisco - Jitter - NumOfRTTs**
      ...
      No. of RTT's that were successfully measured
...
- **FRU Temperature**
  - **Cisco - FRU Temperature - Temperature** (C)

      
- **Cisco LoadBalancer Connections**
...
- **Generic**
- **Sensor Temperature**
  - **Cisco - Sensor Temperature - Temperature** (C)
...
- **Cisco Wireless Client**
  - **Cisco - Cisco Wireless Client - Number of clients**
...
- **Airespace Memory**
  - **Cisco - Airespace Memory - Utilization** (%)
...
- **Fan**
  - **Digital China - Fan - Status**

      
## AKCP
- **AKCP**
- **AKCP Switch**
  - **AKCP - AKCP Switch - Status**
...
- **Alcatel Physical OP Status**
  - **Alcatel - Alcatel Physical OP Status - Status**

      
- **Alcatel Board Temperature**
  - **Alcatel - Alcatel Board Temperature - Temperature** (C)

      
- **Alcatel Secondary Chassis LED**
  - **Alcatel - Alcatel Secondary Chassis LED - Status**
...
- **Alcatel Fabric LED**
  - **Alcatel - Alcatel Fabric LED - Status**
...
- **Alcatel Control LED**
  - **Alcatel - Alcatel Control LED - Status**

      
- **Alcatel LAN Power Status**
  - **Alcatel - Alcatel LAN Power Status - Status**

      
- **Alcatel Memory**
  - **Alcatel - Alcatel Memory - Utilization** (%)
...
- **Alcatel CPU Temperature**
  - **Alcatel - Alcatel CPU Temperature - Temperature** (C)

      
- **Alcatel Temperature LED**
  - **Alcatel - Alcatel Temperature LED - Status**

      
- **Alcatel Fan2 Status**
  - **Alcatel - Alcatel Fan2 Status - Status**

      
- **Alcatel Fan1 Status**
  - **Alcatel - Alcatel Fan1 Status - Status**

      
- **Alcatel Fan3 Status**
  - **Alcatel - Alcatel Fan3 Status - Status**

      
- **Alcatel Primary Chassis LED**
  - **Alcatel - Alcatel Primary Chassis LED - Status**

      
- **Alcatel CPU**
  - **Alcatel - Alcatel CPU - Utilization** (%)

      
- **CPU**
  - **Alcatel - CPU - Utilization** (%)

      
- **Alcatel CPU Utilization**
  - **Alcatel - Alcatel CPU Utilization - Utilization**
...
- **Port receive statistics**
  ...
  - **Overture - Port receive statistics - CRCErrors**
      ...
      Transmitted packets with a bad non-appended CRC field. This count doesn't include any packets with a bad CRC due to a FIFO underflow
...
- **GPON Temperature**
  - **ZTE - GPON Temperature - Temperature** (C)
...
## DLink
- **CPU**
  - **DLink - CPU - Utilization** (%)

      
- **DLink**
- **D-Link Fan**
  - **DLink - D-Link Fan - State**
...
- **Procurve**
- **CPU**
  - **HP - CPU - CPU Utilization** (%)

      
- **Free Memory**
  - **HP - Free Memory - Free Memory** (B)
...
## Ruckus
- **PPOE Status**
  - **Ruckus - PPOE Status - PPOE Status**
...
- **Memory**
  - **Raisecom - Memory - Total memory** (KB)
...
- **CPU**
  - **Raisecom - CPU - CPU busy 1percent** (%)
...
- **Temperature**
  - **Raisecom - Temperature - Temperature** (C)

      Temperature Value
- **Volt**
  - **Raisecom - Volt - Volt Reference** (millivolt)
...
- **Cloud Controller**
- **Cloud Device**
  - **Cloud Controller - Cloud Device - Device status**
...
- **Carel**
- **Analog Objects**
  - **Carel - Analog Objects - ret-air-tmp**
...
- **Digital Objects**
  - **Carel - Digital Objects - dehum-on**
...
- **Integer Objects**
  - **Carel - Integer Objects - disch-air-lo-sp**
  ...
  - **Carel - Integer Objects - assist-sel**
      ...
      0= no comp assist, 1=one comp assist, 2= two comp assist, 3... 4...
...
- **Alarm Monitor**
  - **SSU - Alarm Monitor - Last checked**
...
- **Alteon Application Switch Temperature**
  - **Nortel - Alteon Application Switch Temperature - Status**
...
- **Alteon Application Switch Fan**
  - **Nortel - Alteon Application Switch Fan - Status**

      
- **Alteon Application Switch Enhanced Real Server SLB**
...
- **Alteon Application Switch Power Supply**
  - **Nortel - Alteon Application Switch Power Supply - Status**
...
- **Alteon Application Switch CPU**
  - **Nortel - Alteon Application Switch CPU - CPU Utilization** (%)

      
- **Alteon Application Switch Virtual Server SLB**
...
- **Alteon Application Switch Memory**
  - **Nortel - Alteon Application Switch Memory - Utilization** (%)
...
## ANTlabs
- **Client Info**
  - **ANTlabs - Client Info - Total Detected Devices**
...
- **VLAN Client Info**
  - **ANTlabs - VLAN Client Info - Index**
...
- **ANTlabs**
- **Downstream VLAN Client Info**
  - **ANTlabs - Downstream VLAN Client Info - Index**
...
## Overture 65
- **DC Power**
  - **Overture 65 - DC Power - DC1 Status**
  ...
  - **Overture 65 - DC Power - Voltage** (V)
      ...
      DC Voltage.
- **System IP Route**
  - **Overture 65 - System IP Route - Index**
...
- **DM**
  ...
  - **Overture 65 - DM - Elapsed Time**
      ...
      Elapsed Time
- **Temperature 2**
  - **Overture 65 - Temperature 2 - Centigrade** (C)
...
- **Temperature 1**
  - **Overture 65 - Temperature 1 - Centigrade** (C)
...
- **AC Power**
  ...
  - **Overture 65 - AC Power - Voltage** (V)
      ...
      AC Voltage.
- **System IP Interface**
  - **Overture 65 - System IP Interface - Index**
...
## HIKVision
- **Online Status**
  - **HIKVision - Online Status - Status**

      
- **CPU Frequency**
  - **HIKVision - CPU Frequency - CPU Frequency**

      
- **Device Status**
  - **HIKVision - Device Status - Status**
...
- **Memory Usage**
  - **HIKVision - Memory Usage - Memory usage** (%)

      
- **Camera Events**
  - **HIKVision - Camera Events - new events count**
...
## Xirrus
- **RadiusServerAD Info**
  - **Xirrus - RadiusServerAD Info - DirectoryUser**
...
- **Vlan Mgmt App Stats**
  - **Xirrus - Vlan Mgmt App Stats - Tx Packets**
...
- **Station App Stats**
  - **Xirrus - Station App Stats - Tx Packets**
  ...
  - **Xirrus - Station App Stats - Time Period**
      ...
      Time period over which application stats were collected
- **neighbor arrays seen by our array**
  - **Xirrus - neighbor arrays seen by our array - HostName**
...
- **Administrator history**
  - **Xirrus - Administrator history - IP Adress**
  ...
  - **Xirrus - Administrator history - Logout Time**
      ...
      Admin logout time
- **RadiusServerExternal Info**
  - **Xirrus - RadiusServerExternal Info - PriIP**
...
- **Xirrus**
- **Vlan Management App Category Stats**
  - **Xirrus - Vlan Management App Category Stats - TxPackets** (kbps)
...
- **Vlan Stats**
  ...
  - **Xirrus - Vlan Stats - Time Period**
      ...
      Time period over which stats were collected
- **Interface IAPs**
  - **Xirrus - Interface IAPs - NumStations**
...
- **Real Time Monitor**
  - **Xirrus - Real Time Monitor - Channel No**
...
- **SSID Info**
  ...
  - **Xirrus - SSID Info - RadiusFailoverTimeout**
      ...
      Timeout before failover to another server after current server failed
- **App Category Stats**
  - **Xirrus - App Category Stats - Guid**
  ...
  - **Xirrus - App Category Stats - Time Period**
      ...
      Time period over which stats were collected
- **Environment Control**
  - **Xirrus - Environment Control - Temperature** (C)
...
- **Station Stats**
  - **Xirrus - Station Stats - Rx Bytes** (bytes)
...
## Brocade
- **Operational Status**
  - **Brocade - Operational Status - Status**

      
- **CPU**
  - **Brocade - CPU - Utilization** (%)

      
- **Brocade**
- **Beacon Status**
  - **Brocade - Beacon Status - Status**

      
- **Brocade Port Parameters**
...
- **MPU's CPU and Memory**
  - **Huawei - MPU's CPU and Memory - CPU-5s** (%)

      
  - **Huawei - MPU's CPU and Memory - CPU-1m** (%)

      
  - **Huawei - MPU's CPU and Memory - MemTotal** (MB)

      Total memory size
  - **Huawei - MPU's CPU and Memory - MemFree** (MB)

      Free memory size
  - **Huawei - MPU's CPU and Memory - MemUtil** (%)

      Memory utilization
- **FibreHome CPU**
  - **Huawei - FibreHome CPU - Utilization** (%)
...
- **Management**
- **Entity Power Supply**
  - **Huawei - Entity Power Supply - Status**
...
- **UPS Temperature**
  - **Huawei - UPS Temperature - Temperature** (C)
...
- **Entity Temperature**
  - **Huawei - Entity Temperature - Temperature** (C)
...
- **Temperature**
  - **Extreme - Temperature - Temperature** (C)
...
- **APC UPS Battery Time Remaining**
  - **APC - APC UPS Battery Time Remaining - Battery Time Remaining** (mins)

      
- **APC UPS Battery Capacity**
  - **APC - APC UPS Battery Capacity - Battery Capacity** (%)

      
- **APC Air IRRP100 > Unit Status**
...
- **APC UPS Output Frequency**
  - **APC - APC UPS Output Frequency - Output Frequency** (Hz)

      
- **APC UPS Output Voltage**
  - **APC - APC UPS Output Voltage - Output Voltage** (VAC)

      
- **APC Air IRRP100 > Group Setpoints**
...
- **APC UPS Battery Status**
  - **APC - APC UPS Battery Status - Battery Status**
...
- **APC UPS Time On Battery**
  - **APC - APC UPS Time On Battery - Time On Battery** (ms)

      
- **APC UPS Battery Temperature**
  - **APC - APC UPS Battery Temperature - Battery Temperature** (°C)

      
- **APC UPS Replace Battery Indicator**
  - **APC - APC UPS Replace Battery Indicator - Replace Battery Indicator**

      
- **APC Air IRRP100 > Group Config**
...
- **APC UPS Output Status**
  - **APC - APC UPS Output Status - Output Status**

      
## Peplink
- **CPU Load**
  - **Peplink - CPU Load - CPU Load** (%)

      
- **Uptime**
  - **Peplink - Uptime - Uptime** (secs)
...
## CCTV
- **Video Standard**
  - **CCTV - Video Standard - Video Standard**
...
- **Internal Temperature**
  - **CCTV - Internal Temperature - Device Temperature**
...
- **Add Stream1**
  ...
  - **CCTV - Add Stream1 - Pause**
      ...
      When streamPause the stream will not be send to network
- **No of Video Streams**
  - **CCTV - No of Video Streams - No of video streams**
...
- **XPPC UPS Battery Run Time Remaining**
  - **Generic - XPPC UPS Battery Run Time Remaining - Battery Run Time Remaining** (secs)

      
- **Modem SNR**
- **RAD SNR**
  - **Generic - RAD SNR - SNR** (dBm)
...
- **Active Alarms**
  - **Generic - Active Alarms - No of Active Alarms**

      
- **Calls Recorded**
  - **Generic - Calls Recorded - Calls Recorded**
...
- **XPPC UPS Battery Temperature**
  - **Generic - XPPC UPS Battery Temperature - Battery Temperature** (C)

      
- **XPPC UPS Battery Status**
  - **Generic - XPPC UPS Battery Status - XPPC Battery Status**
...
- **OSPF Neighbour**
  - **Generic - OSPF Neighbour - State**

      
- **UPS Battery Status**
  - **Generic - UPS Battery Status - Battery Status**

      
- **Harris Wifi Rx Level**
  - **Generic - Harris Wifi Rx Level - Rx Level** (dBm)

      
- **UPS Time On Battery**
  - **Generic - UPS Time On Battery - Time On Battery** (secs)

      
- **Radius**
  - **Generic - Radius - Response Time** (ms)
...
- **Radwin Wifi Rx Level**
  - **Generic - Radwin Wifi Rx Level - Rx Level** (dBm)
...
- **Mimotec Wifi Rx Level**
  - **Generic - Mimotec Wifi Rx Level - Rx Level** (dBm)

      
- **Unarchived Data Amount**
  - **Generic - Unarchived Data Amount - Amount of Unarchived Data**
...
- **UPS**
- **Proscend SNR**
  - **Generic - Proscend SNR - SNR** (dBm)

      
- **UPS Battery Capacity**
  - **Generic - UPS Battery Capacity - Battery Capacity** (%)

      
- **Wifi Rx Level 2**
  - **Generic - Wifi Rx Level 2 - Rx Level** (dBm)

      
- **XPPC UPS Battery Voltage**
  - **Generic - XPPC UPS Battery Voltage - Battery Voltage** (VDC)
...
- **Wifi Rx Level 1**
  - **Generic - Wifi Rx Level 1 - Rx Level** (dBm)

      
- **BGP Peer**
  - **Generic - BGP Peer - State**
...
- **XPPC UPS Replace Battery Indicator**
  - **Generic - XPPC UPS Replace Battery Indicator - Replace Battery Indicator**
...
- **XPPC UPS Battery Current**
  - **Generic - XPPC UPS Battery Current - Battery Current** (%)

      
- **XPPC UPS Battery Capacity**
  - **Generic - XPPC UPS Battery Capacity - Battery Capacity** (%)

      
- **XPPC UPS Time On Battery**
  - **Generic - XPPC UPS Time On Battery - Time On Battery** (secs)

      
- **EMS Input Contact Status**
...
- **VRF Security**
  - **Generic - VRF Security - Illegal label violations**

      
- **UPS Battery Time Remaining**
  - **Generic - UPS Battery Time Remaining - Battery Time Remaining** (mins)
...
- **TCP Port**
  - **Generic - TCP Port - Response Time** (ms)
...
## Foundry
- **Temperature**
  - **Foundry - Temperature - Temperature** (C)
...
- **CPU**
  - **Foundry - CPU - Utilization** (%)

      
- **Power supply**
  - **Foundry - Power supply - Status**
...
- **H3C IPSEC**
  ...
  - **H3C - H3C IPSEC - InAuthFails**
      ...
      Inbound authentication's which ended in failure
  - **H3C - H3C IPSEC - InDecryptFails**

      Inbound decryption's which ended in failure
  ...
  - **H3C - H3C IPSEC - OutEncryptFails**
      ...
      Outbound encryption's which ended in failure
...
- **Online users**
  - **HillStone - Online users - User count**
...
- **LiebertUpsStatus**
  ...
  - **Liebert - LiebertUpsStatus - Heating capacity** (%)
      ...
      Heating capacity
- **Liebert GP Humidity**
  - **Liebert - Liebert GP Humidity - Humidity** (%)

      
- **Liebert GP Temperature**
  - **Liebert - Liebert GP Temperature - Temperature** (C)
...
- **Enterasys Power Supply**
  - **Enterasys - Enterasys Power Supply - State**

      
- **Enterasys Fan**
  - **Enterasys - Enterasys Fan - State**

      
- **Memory**
  - **Enterasys - Memory - Utilization** (%)

      
- **Enterasys**
## Array
- **Reverse Proxy Cache Requests**
...
- **Cache**
  - **Bluecoat - Cache - Objects count**

      
- **Disk**
  - **Bluecoat - Disk - Status**

      
- **Memory**
  - **Bluecoat - Memory - Utilization** (%)
...
- **Network Utilization**
  - **Radware - Network Utilization - Network Utilization** (%)

      
- **Radware**
## TWAG
- **DeleteSessionMonitor**
  - **TWAG - DeleteSessionMonitor - Total number of request messages**
...
- **CreateSessionMonitor**
  - **TWAG - CreateSessionMonitor - Total number of request messages**
...
- **Alarm Monitor**
  - **Avaya - Alarm Monitor - Last checked**

      
- **Avaya**
## WRI
- **WriMemoryPoolMonitor**
...
## AscenLink
- **CPU**
  - **AscenLink - CPU - Utilization** (%)

      
- **Connections**
  - **AscenLink - Connections - Connections**
...
- **AscenLink**
## Emerson
- **Ita Group2 > Output Power Factor**
...
## Orion
- **Orion System Alarms**
  - **Orion - Orion System Alarms - Number of urgent alarms**
...
- **Rectifier Module**
  - **Orion - Rectifier Module - Slot state**
...
- **Orion System**
  - **Orion - Orion System - Voltage** ( 10 mV)
...
- **Orion Rectifier**
  - **Orion - Orion Rectifier - Number of recitifiers**
...
- **Power Supply**
  - **Force10 - Power Supply - Operational Status**
...
- **NetFan**
  - **Force10 - NetFan - Operational Status**
...
- **Fan**
  - **Force10 - Fan - Operational Status**
