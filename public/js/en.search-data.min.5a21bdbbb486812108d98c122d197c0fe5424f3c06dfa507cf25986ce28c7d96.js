...
Add an API integration for Free plan, Essentials plan and Jira Service Management&rsquo;s Standard plan Go to Teams and add your team.
Enter team details.
Select Integrations on the left navigation and then select Add integration.
Search for API.
Enter integration name &gt; select team &gt; click continue.
Click turn on integration and copy API key.
Adding the integration from your team dashboard will make your team the owner of the integration. This means Opsgenie will assign the alerts received through this integration to your team only. Follow the rest of the steps in this section to set up the integration. If the Owner of your Opsgenie account has not verified their email yet, users within your organization will not be able use API integrations.
