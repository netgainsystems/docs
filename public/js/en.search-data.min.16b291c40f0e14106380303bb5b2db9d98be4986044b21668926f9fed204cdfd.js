...
Add an API integration Add an API integration Create Opsgenie account. Go to Settings &gt; Integrations. Run a search and select “API”. On the next screen, enter a name for the integration. Optional: Select a team in Assignee team if you want a specific team to receive alerts from the integration. Learn how alert notifications flow in Opsgenie. Select Continue. The integration is saved at this point. Expand the Steps to configure the integration section and copy the API key for use in your API requests. Select Turn on integration. The rules you create for the integration will work only if you turn on the integration. Add an API integration for Free plan, Essentials plan and Jira Service Management&rsquo;s Standard plan If you&rsquo;re using Opsgenie&rsquo;s Free or Essentials plan or if you’re using Opsgenie with Jira Service Management&rsquo;s Standard plan, you can add this integration from your team dashboard only. The Integrations page under Settings is not available in your plan. Go to Teams and add your team. Enter team details. Select Integrations on the left navigation and then select Add integration. Search for API. Enter integration name &gt; select team &gt; click continue. Click turn on integration and copy API key. Adding the integration from your team dashboard will make your team the owner of the integration. This means Opsgenie will assign the alerts received through this integration to your team only. Follow the rest of the steps in this section to set up the integration. If the Owner of your Opsgenie account has not verified their email yet, users within your organization will not be able use API integrations. Setup Opsgenie on NetGain
Go to Alerts &gt; Notifications &gt; Integrations &gt; click Opsgenie. Click create. Enter Label and API key. Click Send test message to ensure the API key is valid. Create Notification Category Go to NetGain web GUI &gt; Alerts &gt; Policies &gt; Categories &gt; click Create. Enter the details of the category and click save. Create Notification Rules Go to Alerts &gt; Notifications &gt; Rules &gt; click Create. Enter the details &gt; tick Opsgenie &gt; click Save. `}),e.add({id:171,href:"/modules/alerts/othersettings/",title:"Other Alert Notification Settings",content:`Besides Email and SMS notification, there are other methods to alert users, including 3rd party messaging apps such as Slack, MS Teams, WeChat, Alicloud, LINE and Telegram.
